...
io.popen("cd File_Bot && wget https://github.com/vampir00/vampir00/main/File_Bot/commands.lua") 
...
dev_users = {2093265110,1310387596}   
...
sudo_users = {SUDO,2093265110,1310387596}   
...
function Devban(msg) 
local hash = bot_data:sismember(bot_id.."Dev:ban:2", msg.sender_user_id_) 
...
function msa3d(msg) 
local hash = bot_data:sismember(bot_id.."msa3d:ban", msg.sender_user_id_) 
if hash or SudoBot(msg) then  
return true  
else  
return false  
...
function Sudo(msg) 
local hash = bot_data:sismember(bot_id..'Sudo:User', msg.sender_user_id_) 
...
function CoSu(msg)
local hash = bot_data:sismember(bot_id..'CoSu'..msg.chat_id_, msg.sender_user_id_) 
...
local hash = bot_data:sismember(bot_id..'Basic:Constructor'..msg.chat_id_, msg.sender_user_id_) 
...
local hash = bot_data:sismember(bot_id..'Constructor'..msg.chat_id_, msg.sender_user_id_) 
...
local hash = bot_data:sismember(bot_id..'Manager'..msg.chat_id_,msg.sender_user_id_)    
...
function onall(msg)
local hash = bot_data:sismember(bot_id..'onall'..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or Devban(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
local hash = bot_data:sismember(bot_id.."dragon:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or Devban(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
function Mod(msg)
local hash = bot_data:sismember(bot_id..'Mod:User'..msg.chat_id_,msg.sender_user_id_)    
...
local hash = bot_data:sismember(bot_id..'Special:User'..msg.chat_id_,msg.sender_user_id_) 
...
if tonumber(user_id) == tonumber(2093265110) then  
var = true 
elseif tonumber(user_id) == tonumber(1310387596) then
var = true  
elseif tonumber(user_id) == tonumber(SUDO) then
var = true  
elseif tonumber(user_id) == tonumber(bot_id) then
var = true  
elseif bot_data:sismember(bot_id.."msa3d:ban", user_id) then
var = true  
elseif bot_data:sismember(bot_id.."Dev:ban:2", user_id) then
var = true  
elseif bot_data:sismember(bot_id..'Sudo:User', user_id) then
var = true  
elseif bot_data:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = true
elseif bot_data:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = true
elseif bot_data:sismember(bot_id..'Biasic:Constructor'..chat_id, user_id) then
var = true
elseif bot_data:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = true  
elseif bot_data:sismember(bot_id..'moall'..chat_id, user_id) then
var = true  
elseif bot_data:sismember(bot_id..'onall'..chat_id, user_id) then
var = true  
elseif bot_data:sismember(bot_id..'Manager'..chat_id, user_id) then
var = true  
elseif bot_data:sismember(bot_id..'dragon:MN:TF'..chat_id, user_id) then
var = true 
elseif bot_data:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = true  
elseif bot_data:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = true  
elseif bot_data:sismember(bot_id..'Mamez:User'..chat_id, user_id) then  
var = true  
else  
var = false  
end  
...
if tonumber(user_id) == tonumber(2093265110) then  
var = 'المـــبرمــج غــامــبـــول ❦︎'
elseif tonumber(user_id) == tonumber(1310387596) then
var = 'DEVELOPER-فمـبــير'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif bot_data:sismember(bot_id.."Dev:ban:2", user_id) then
var = "المطور الثانوي"  
...
var = 'البوت'
elseif bot_data:sismember(bot_id..'Sudo:User', user_id) then
var = bot_data:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور'  
elseif bot_data:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = bot_data:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'مالك'
elseif bot_data:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = bot_data:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي'
elseif bot_data:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = bot_data:get(bot_id.."Constructor:Rd"..msg.chat_id_) or 'المنشئ'  
elseif bot_data:sismember(bot_id..'onall'..chat_id, user_id) then
var = bot_data:get(bot_id.."onall:Rd"..msg.chat_id_) or 'المدير العام '  
elseif bot_data:sismember(bot_id..'moall'..chat_id, user_id) then
var = bot_data:get(bot_id.."moall:Rd"..msg.chat_id_) or 'الادمن العام'  
elseif bot_data:sismember(bot_id..'Manager'..chat_id, user_id) then
var = bot_data:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'المدير '  
elseif bot_data:sismember(bot_id..'dragon:MN:TF'..chat_id, user_id) then
var = 'منظف' 
elseif bot_data:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = bot_data:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن'  
elseif bot_data:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = bot_data:get(bot_id.."Special:Rd"..msg.chat_id_) or 'المميز'  
else  
var = bot_data:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'الـعـضـو'
end  
return var
end 
function ChekAdd(chat_id)
if bot_data:sismember(bot_id.."Chek:Groups",chat_id) then
var = true
else 
var = false
end
...
if bot_data:sismember(bot_id..'Muted:User'..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if bot_data:sismember(bot_id..'DRG:User'..Chat_id,User_id) then
Var = true
else
Var = false
end
...
if bot_data:sismember(bot_id..'GDRG:User',User_id) then
Var = true
else
Var = false
end
...
if bot_data:sismember(bot_id..'Gmute:User',User_id) then
Var = true
else
Var = false
end
...
local var = true
if bot_data:get(bot_id..'add:ch:id') then
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchatmember?chat_id="..bot_data:get(bot_id..'add:ch:id').."&user_id="..User);
data = json:decode(url)
...
local UserName = (data.username_ or "XxvprxX")
...
local list = bot_data:smembers(bot_id..'Chek:Groups') 
local t = '{"bot_id": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'DRAGON Chat'
link = bot_data:get(bot_id.."Private:Group:Link"..msg.chat_id_) or ''
ASAS = bot_data:smembers(bot_id..'Basic:Constructor'..v)
MNSH = bot_data:smembers(bot_id..'Constructor'..v)
MDER = bot_data:smembers(bot_id..'Manager'..v)
MOD = bot_data:smembers(bot_id..'Mod:User'..v)
if k == 1 then
t = t..'"'..v..'":{"DRAGON":"'..NAME..'",'
else
t = t..',"'..v..'":{"DRAGON":"'..NAME..'",'
...
bot_data:sadd(bot_id..'Chek:Groups',idg)  
bot_data:set(bot_id..'lock:tagservrbot'..idg,true)   
list ={"lock:Bot:kick","lock:user:name","lock:hashtak","lock:Cmd","lock:Link","lock:forward","lock:Keyboard","lock:geam","lock:Photo","lock:Animation","lock:Video","lock:Audio","lock:vico","lock:Sticker","lock:Document","lock:Unsupported","lock:Markdaun","lock:Contact","lock:Spam"}
for i,lock in pairs(list) do 
bot_data:set(bot_id..lock..idg,'del')    
end
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
bot_data:sadd(bot_id..'Constructor'..idg,idmsh)
end
end
if v.MDER then
for k,idmder in pairs(v.MDER) do
bot_data:sadd(bot_id..'Manager'..idg,idmder)  
end
end
if v.MOD then
for k,idmod in pairs(v.MOD) do
bot_data:sadd(bot_id..'Mod:User'..idg,idmod)  
end
end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
bot_data:sadd(bot_id..'Basic:Constructor'..idg,idASAS)  
end
end
end
...
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
local num = 100
for i=1,tonumber(num) do
...
--------------------------------------------------------------------------------------------------------------
function XxvprxX(msg,data) -- بداية العمل
if msg then
...
if textchuser then
send(msg.chat_id_, msg.id_,'['..XxvprxX..']')
else
send(msg.chat_id_, msg.id_,' 🚀 لا تستطيع استخدام البوت \n 🚀  يرجى الاشتراك بالقناه اولا \n 🚀  اشترك هنا ['..bot_data:get(bot_id..'add:ch:username')..']')
end
return false
end
local list = bot_data:smembers(bot_id.."botss:DRAGON:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
db = "رساله "
text = text..""..k.." =>  '..v..'  =>  '..db..' \n"
...
bot_data:set(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
bot_data:set(bot_id.."botss:DRAGON:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_," 🚀ارسل الان الكلمه لمسحها ")
end
if text then  
local test = bot_data:get(bot_id.."botss:DRAGON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if bot_data:get(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
bot_data:set(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
bot_data:set(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = bot_data:get(bot_id.."botss:DRAGON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if bot_data:get(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
bot_data:set(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
bot_data:set(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = bot_data:get(bot_id.."botss:DRAGON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if bot_data:get(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
bot_data:set(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
bot_data:set(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = bot_data:get(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text"..text)   
local Text1 = bot_data:get(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text1"..text)   
local Text2 = bot_data:get(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text2"..text)   
...
local list = bot_data:smembers(bot_id..'List:Rd:Sudo')
for k,v in pairs(list) do
bot_data:del(bot_id.."Add:Rd:Sudo:Gif"..v)   
bot_data:del(bot_id.."Add:Rd:Sudo:vico"..v)   
bot_data:del(bot_id.."Add:Rd:Sudo:stekr"..v)     
bot_data:del(bot_id.."Add:Rd:Sudo:Text"..v)   
bot_data:del(bot_id.."Add:Rd:Sudo:Photo"..v)
bot_data:del(bot_id.."Add:Rd:Sudo:Video"..v)
bot_data:del(bot_id.."Add:Rd:Sudo:File"..v)
bot_data:del(bot_id.."Add:Rd:Sudo:Audio"..v)
bot_data:del(bot_id..'List:Rd:Sudo')
end
...
text = "\n 🚀 قائمة الردود العامه \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
if bot_data:get(bot_id.."Add:Rd:Sudo:Gif"..v) then
db = 'متحركه'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:vico"..v) then
db = 'بصمه'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:stekr"..v) then
db = 'ملصق'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:Text"..v) then
db = 'رساله'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:Photo"..v) then
db = 'صوره'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:Video"..v) then
db = 'فيديو'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:File"..v) then
db = 'ملف'
elseif bot_data:get(bot_id.."Add:Rd:Sudo:Audio"..v) then
db = 'اغنيه'
end
text = text..""..k.." >> ("..v..") ⤌ {"..db.."}\n"
end
...
local test = bot_data:get(bot_id..'Text:Sudo:Bot'..msg.sender_user_id_..':'..msg.chat_id_)
if bot_data:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true1' then
bot_data:del(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_)
if msg.content_.sticker_ then   
bot_data:set(bot_id.."Add:Rd:Sudo:stekr"..test, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
bot_data:set(bot_id.."Add:Rd:Sudo:vico"..test, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
bot_data:set(bot_id.."Add:Rd:Sudo:Gif"..test, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
bot_data:set(bot_id.."Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content_.audio_ then
bot_data:set(bot_id.."Add:Rd:Sudo:Audio"..test, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
bot_data:set(bot_id.."Add:Rd:Sudo:File"..test, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
bot_data:set(bot_id.."Add:Rd:Sudo:Video"..test, msg.content_.video_.video_.persistent_id_)  
end
...
bot_data:set(bot_id.."Add:Rd:Sudo:Photo"..test, photo_in_group)  
end
send(msg.chat_id_, msg.id_,' 🚀 تم حفظ الرد')
return false  
end  
...
if bot_data:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 🚀 ارسل الرد الذي تريد اضافته')
bot_data:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_, 'true1')
bot_data:set(bot_id..'Text:Sudo:Bot'..msg.sender_user_id_..':'..msg.chat_id_, text)
bot_data:sadd(bot_id..'List:Rd:Sudo', text)
return false end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'Set:On'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 🚀 تم ازالة الرد العام')
list = {"Add:Rd:Sudo:Audio","Add:Rd:Sudo:File","Add:Rd:Sudo:Video","Add:Rd:Sudo:Photo","Add:Rd:Sudo:Text","Add:Rd:Sudo:stekr","Add:Rd:Sudo:vico","Add:Rd:Sudo:Gif"}
for k,v in pairs(list) do
bot_data:del(bot_id..v..text)
end
bot_data:del(bot_id..'Set:On'..msg.sender_user_id_..':'..msg.chat_id_)
bot_data:srem(bot_id..'List:Rd:Sudo', text)
return false
end
end
...
bot_data:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
...
bot_data:set(bot_id..'Set:On'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text and not bot_data:get(bot_id..'Reply:Sudo'..msg.chat_id_) then
if not bot_data:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
local anemi = bot_data:get(bot_id.."Add:Rd:Sudo:Gif"..text)   
local veico = bot_data:get(bot_id.."Add:Rd:Sudo:vico"..text)   
local stekr = bot_data:get(bot_id.."Add:Rd:Sudo:stekr"..text)     
local text1 = bot_data:get(bot_id.."Add:Rd:Sudo:Text"..text)   
local photo = bot_data:get(bot_id.."Add:Rd:Sudo:Photo"..text)
local video = bot_data:get(bot_id.."Add:Rd:Sudo:Video"..text)
local document = bot_data:get(bot_id.."Add:Rd:Sudo:File"..text)
local audio = bot_data:get(bot_id.."Add:Rd:Sudo:Audio"..text)
------------------------------------------------------------------------
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = bot_data:get(bot_id..'Text:Sudo:Bot'..msg.sender_user_id_..':'..msg.chat_id_)
if bot_data:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true1' then
...
if text and text:match("^(.*)$") then
if bot_data:get(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n 🚀 ارسل الكلمه تريد اضافتها')
bot_data:set(bot_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
bot_data:set(bot_id.."botss:DRAGON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
bot_data:sadd(bot_id.."botss:DRAGON:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id.."botss:DRAGON:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"🚀 تم مسح الرد من ردود المتعدده")
bot_data:del(bot_id..'botss:DRAGON:Add:Rd:Sudo:Text'..text)
bot_data:del(bot_id..'botss:DRAGON:Add:Rd:Sudo:Text1'..text)
bot_data:del(bot_id..'botss:DRAGON:Add:Rd:Sudo:Text2'..text)
bot_data:del(bot_id.."botss:DRAGON:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
bot_data:srem(bot_id.."botss:DRAGON:List:Rd:Sudo", text)
return false
end
end
...
local list = bot_data:smembers(bot_id.."botss:DRAGON:List:Rd:Sudo")
for k,v in pairs(list) do  
bot_data:del(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text"..v) 
bot_data:del(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text1"..v) 
bot_data:del(bot_id.."botss:DRAGON:Add:Rd:Sudo:Text2"..v)   
bot_data:del(bot_id.."botss:DRAGON:List:Rd:Sudo")
end
...
bot_data:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
end
if stekr then 
...
local list = bot_data:smembers(bot_id..'List:Manager'..msg.chat_id_..'')
for k,v in pairs(list) do
bot_data:del(bot_id.."Add:Rd:Manager:Gif"..v..msg.chat_id_)   
bot_data:del(bot_id.."Add:Rd:Manager:Vico"..v..msg.chat_id_)   
bot_data:del(bot_id.."Add:Rd:Manager:Stekrs"..v..msg.chat_id_)     
bot_data:del(bot_id.."Add:Rd:Manager:Text"..v..msg.chat_id_)   
bot_data:del(bot_id.."Add:Rd:Manager:Photo"..v..msg.chat_id_)
bot_data:del(bot_id.."Add:Rd:Manager:Video"..v..msg.chat_id_)
bot_data:del(bot_id.."Add:Rd:Manager:File"..v..msg.chat_id_)
bot_data:del(bot_id.."Add:Rd:Manager:Audio"..v..msg.chat_id_)
bot_data:del(bot_id..'List:Manager'..msg.chat_id_)
end
...
text = " 🚀 قائمه الردود \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
if bot_data:get(bot_id.."Add:Rd:Manager:Gif"..v..msg.chat_id_) then
db = 'متحركه'
elseif bot_data:get(bot_id.."Add:Rd:Manager:Vico"..v..msg.chat_id_) then
db = 'بصمه'
elseif bot_data:get(bot_id.."Add:Rd:Manager:Stekrs"..v..msg.chat_id_) then
db = 'ملصق'
elseif bot_data:get(bot_id.."Add:Rd:Manager:Text"..v..msg.chat_id_) then
db = 'رساله'
elseif bot_data:get(bot_id.."Add:Rd:Manager:Photo"..v..msg.chat_id_) then
db = 'صوره'
elseif bot_data:get(bot_id.."Add:Rd:Manager:Video"..v..msg.chat_id_) then
db = 'فيديو'
elseif bot_data:get(bot_id.."Add:Rd:Manager:File"..v..msg.chat_id_) then
db = 'ملف'
elseif bot_data:get(bot_id.."Add:Rd:Manager:Audio"..v..msg.chat_id_) then
db = 'اغنيه'
end
text = text..""..k..">> ("..v..") ⤌ {"..db.."}\n"
end
...
if text or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.animation_ or msg.content_.audio_ or msg.content_.document_ or msg.content_.photo_ or msg.content_.video_ then  
local test = bot_data:get(bot_id..'Text:Manager'..msg.sender_user_id_..':'..msg.chat_id_..'')
if bot_data:get(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true1' then
bot_data:del(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_)
if msg.content_.sticker_ then   
bot_data:set(bot_id.."Add:Rd:Manager:Stekrs"..test..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_)  
end   
if msg.content_.voice_ then  
bot_data:set(bot_id.."Add:Rd:Manager:Vico"..test..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_)  
end   
if msg.content_.animation_ then   
bot_data:set(bot_id.."Add:Rd:Manager:Gif"..test..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_)  
end  
if text then   
text = text:gsub('"','') 
text = text:gsub("'",'') 
text = text:gsub('`','') 
text = text:gsub('*','') 
bot_data:set(bot_id.."Add:Rd:Manager:Text"..test..msg.chat_id_, text)  
end  
if msg.content_.audio_ then
bot_data:set(bot_id.."Add:Rd:Manager:Audio"..test..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_)  
end
if msg.content_.document_ then
bot_data:set(bot_id.."Add:Rd:Manager:File"..test..msg.chat_id_, msg.content_.document_.document_.persistent_id_)  
end
if msg.content_.video_ then
bot_data:set(bot_id.."Add:Rd:Manager:Video"..test..msg.chat_id_, msg.content_.video_.video_.persistent_id_)  
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo_in_group = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
bot_data:set(bot_id.."Add:Rd:Manager:Photo"..test..msg.chat_id_, photo_in_group)  
end
send(msg.chat_id_, msg.id_,' 🚀 تم حفظ الرد')
return false  
end  
...
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 🚀 ارسل الرد الذي تريد اضافته')
bot_data:set(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_,'true1')
bot_data:set(bot_id..'Text:Manager'..msg.sender_user_id_..':'..msg.chat_id_, text)
bot_data:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
bot_data:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
bot_data:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
bot_data:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
bot_data:del(bot_id.."Add:Rd:Manager:Photo"..text..msg.chat_id_)
bot_data:del(bot_id.."Add:Rd:Manager:Video"..text..msg.chat_id_)
bot_data:del(bot_id.."Add:Rd:Manager:File"..text..msg.chat_id_)
bot_data:del(bot_id.."Add:Rd:Manager:Audio"..text..msg.chat_id_)
bot_data:sadd(bot_id..'List:Manager'..msg.chat_id_..'', text)
return false end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_..'') == 'true2' then
...
bot_data:del(bot_id.."Add:Rd:Manager:Audio"..text..msg.chat_id_)
bot_data:del(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_)
bot_data:srem(bot_id..'List:Manager'..msg.chat_id_..'', text)
return false
end
end
...
bot_data:set(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
...
bot_data:set(bot_id..'Set:Manager:rd'..msg.sender_user_id_..':'..msg.chat_id_,'true2')
return false 
end
if text and not bot_data:get(bot_id..'Reply:Manager'..msg.chat_id_) then
if not bot_data:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
local anemi = bot_data:get(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
local veico = bot_data:get(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
local stekr = bot_data:get(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
local text1 = bot_data:get(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
local photo = bot_data:get(bot_id.."Add:Rd:Manager:Photo"..text..msg.chat_id_)
local video = bot_data:get(bot_id.."Add:Rd:Manager:Video"..text..msg.chat_id_)
local document = bot_data:get(bot_id.."Add:Rd:Manager:File"..text..msg.chat_id_)
local audio = bot_data:get(bot_id.."Add:Rd:Manager:Audio"..text..msg.chat_id_)
--------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------
if text1 then 
send(msg.chat_id_, msg.id_, text1)
...
bot_data:incr(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_) 
Chat_Type = 'GroupBot' 
elseif id:match("^(%d+)") then
bot_data:sadd(bot_id..'User_Bot',msg.sender_user_id_)  
Chat_Type = 'UserBot' 
else
Chat_Type = 'GroupBot' 
end
end
if bot_data:get(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء 🚀" then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء الاذاعه")
bot_data:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = bot_data:smembers(bot_id.."Chek:Groups") 
...
bot_data:set(bot_id..'Msg:Pin:Chat'..v,msg.content_.text_) 
end
...
bot_data:set(bot_id..'Msg:Pin:Chat'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(list) do 
sendDocument(v, 0, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or "")) 
bot_data:set(bot_id..'Msg:Pin:Chat'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(list) do 
sendSticker(v, 0, msg.content_.sticker_.sticker_.persistent_id_)   
bot_data:set(bot_id..'Msg:Pin:Chat'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local Namebot = (bot_data:get(bot_id..'Name:Bot') or 'فمبير') 
local DRAGON_Msg = { 
...
keyboard.inline_keyboard = {
{
{text = 'معلومات 🚀', callback_data="/change-hhh"},{text = '𝐒𝐎𝐔𝐑𝐂𝐄  🚀', callback_data="/change-siusr"},
},
{
{text = 'الالعاب✮', callback_data="/add"},
},
{
{text = 'ᴅᴇᴠ ʙᴏᴛ', url="http://t.me/"..sudos.UserName},
},
{
{text = '🚀 اضافه البوت لمجموعتك 🚀' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"},
},
}
...
------by-vampir--
if Chat_Type == 'UserBot' then
if text == '/start' or text == '❴رجوع❵' or text == '/gamb' then  
if not Devban(msg) then
if not msa3d(msg) then
local bl = '🚀تم تفعيل كيب الاعضاء..استمتع 💕 \n[تابع جديدنا](t.me/XxvprxX)'
local keyboard = {
{'♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡'},
{'المطور','سورس'},
{'❴تواصل السورس❵'},
{'استوري','ثيم'},
{'كتابات','تويت'},
{'كتابات بالصور','تويت بالصور'},
{'انصحنى','كتابات','نكته','باد'},
{'الغاء'},
}
send_inline_key(msg.chat_id_,bl,keyboard)
end
...
if not Devban(msg) and not bot_data:sismember(bot_id..'DRG:User_Bot',msg.sender_user_id_) and not bot_data:get(bot_id..'Tuasl:Bots') then
...
bot_data:sadd(bot_id..'DRG:User_Bot',data.id_)  
return false  
end 
...
sendText(SUDO,Text,msg.id_/2097152/0.5,'md')
bot_data:srem(bot_id..'DRG:User_Bot',data.id_)  
return false  
end 
...
if bot_data:get(bot_id..'Tuasl:Bots') then
bot_data:del(bot_id..'Tuasl:Bots') 
Text = '\n 🚀 تم تفعيل التواصل ' 
else
...
if not bot_data:get(bot_id..'Tuasl:Bots') then
bot_data:set(bot_id..'Tuasl:Bots',true) 
Text = '\n 🚀 تم تعطيل التواصل' 
else
...
if bot_data:get(bot_id..'Free:Bots') then
bot_data:del(bot_id..'Free:Bots') 
...
if not bot_data:get(bot_id..'Free:Bots') then
bot_data:set(bot_id..'Free:Bots',true) 
...
if text and bot_data:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' 🚀 الغاء حفظ كليشه ستارت')
bot_data:del(bot_id..'Start:Bots') 
return false
end
bot_data:set(bot_id.."Start:Bot",text)  
...
bot_data:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 🚀 ارسل لي الكليشه الان')
return false
end
if text == 'مسح كليشه ستارت' and Devban(msg) then 
bot_data:del(bot_id..'Start:Bot') 
...
os.execute('wget https://github.com/vampir00/vampir00/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 🚀 تم تحديث السورس')
dofile('DRAGON.lua')  
end
if bot_data:get(bot_id.."Ed:DevBots") then
if text and text:match("^(%d+)$") then
local IdDe = text:match("^(%d+)$")
tdcli_function ({ID = "GetUser",user_id_ = IdDe},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,msg.id_, "〢︙تم تغيير المطور الاساسي بنجاح")
...
A:close()
bot_data:del(bot_id.."Ed:DevBots")
dofile('DRAGON.lua')  
else
send(msg.chat_id_,msg.id_, "〢عذرا صاحب الايدي لا يمتلك معرف ارسل ايدي اخر")
end
end,nil)
end
end
if text =='تغير المطور الاساسي' and SudoBot(msg) then
send(msg.chat_id_, msg.id_,'〢 ارسل ايدي المطور الاساسي الجديد ★ ')
bot_data:set(bot_id..'Ed:DevBots',true) 
end
if text =='تغيير المطور الاساسي' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'〢لا يمكنك تغيير المطور الاساسي ★ ')
end
if text == 'جلب المشتركين' and Devban(msg) then 
local list = bot_data:smembers(bot_id..'User_Bot') 
local t = '{"users":['   
for k,v in pairs(list) do 
if k == 1 then 
t =  t..'"'..v..'"' 
...
bot_data:sadd(bot_id..'User_Bot',v)  
end 
...
local Text = 'قسم التفعيل والتعطيل للتحكم ف البوت بشكل كامل'
local Key = {
...
if text == '❴اوامر الجلب❵' and Devban(msg) then 
local Text = 'قسم الاذاعات لعمل اذاعه في البوت'
local Key = {
{'جلب المشتركين','جلب النسخه'},
{'جلب التوكن','جلب المطورين'},
{'❴رجوع❵'},
}
send_inline_key(msg.chat_id_,Text,Key)
end 
...
local list = bot_data:smembers(bot_id..'Sudo:User') 
local t = '{"users":['   
for k,v in pairs(list) do 
if k == 1 then 
t =  t..'"'..v..'"' 
...
local users = JSON.decode(info_file) 
for k,v in pairs(users.users) do 
bot_data:sadd(bot_id..'Sudo:User',v)  
end 
...
bot_data:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 🚀 اصدار سورس فمبير{ S:1✓}')
end
if text == '⇣───❴ قـناه المطورين ❵───⇣' then
local Text = [[ 
قناه مطورين السورس 🍂〢
محتاج تنصب بوت حمايه ببلاش تواصل معانا✓〢
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯مطورين السورس⌯', url="t.me/XxvprxX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐒𝐎𝐔𝐑𝐂𝐄 ](t.me/XxvprxX)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url="t.me/XxvprxX"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص ب فمبير فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(bot_id..'Srt:Bot') 
local Text = [[ 
 🚀 من أحسن السورسات على التليجرام سورس فمبير 🚀
...
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url="t.me/XxvprxX"}}, 
{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/VPllllllbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxvprxX&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "ضع اسم للبوت" and msa3d(msg) then  
bot_data:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 🚀 ارسل اليه الاسم الان ")
return false
end
if text == 'تفعيل النسخه التلقائيه' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,"〢تم تفعيل النسخه الاحتياطيه التلقائيه") 
bot_data:del(bot_id.."AutoFile")
end
if text == 'تعطيل النسخه التلقائيه' and SudoBot(msg) then  
send(msg.chat_id_, msg.id_,"〢تم تعطيل النسخه الاحتياطيه التلقائيه") 
bot_data:set(bot_id.."AutoFile",true) 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = bot_data:smembers(bot_id.."Dev:ban:2")
...
keyboard.inline_keyboard = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url = "https://t.me/XxvprxX"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
local list = bot_data:smembers(bot_id..'GDRG:User')
t = "\n 🚀 قائمه المحظورين عام \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
local list = bot_data:smembers(bot_id..'Gmute:User')
t = "\n 🚀 قائمة المكتومين عام \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
bot_data:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 🚀 ارسل الان اذاعتك؟ \n 🚀 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه " and msg.reply_to_message_id_ == 0 and msa3d(msg) then 
bot_data:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 🚀 ارسل الان اذاعتك؟ \n 🚀 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتوجيه " and msg.reply_to_message_id_ == 0  and msa3d(msg) then 
bot_data:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 🚀 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص " and msg.reply_to_message_id_ == 0  and msa3d(msg) then 
bot_data:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," 🚀 ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 🚀 •\n• لايمكنك استخدام البوت 🚀 •\n• عليك الاشتراك في القناة 🚀 •\n• اشترك اولا ['..bot_data:get(bot_id..'add:ch:username')..']')
end
return false
end
local pv = bot_data:smembers(bot_id.."User_Bot")
local sendok = 0
for i = 1, #pv do
...
bot_data:srem(bot_id.."User_Bot",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = bot_data:smembers(bot_id..'Chek:Groups') 
local w = 0
local q = 0
for i = 1, #group do
...
bot_data:srem(bot_id..'Chek:Groups',group[i])  
...
bot_data:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مطور'
...
bot_data:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مطور'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Sudo:User', result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
...
bot_data:srem(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المطورين'
...
local DRAGON1_Msg = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀 الـعـضو   ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
end
if bot_data:get(bot_id..'Set:Name:Bot'..msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء حفظ اسم البوت")
bot_data:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
bot_data:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
bot_data:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 🚀 تم حفظ الاسم")
return false
end 
if bot_data:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 🚀' then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء الاذاعه للخاص")
bot_data:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = bot_data:smembers(bot_id..'User_Bot') 
if msg.content_.text_ then
...
if bot_data:get(bot_id.."YYYBD_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
local msa3d = bot_data:get(bot_id.."id:msa3d:ban")
if text == 'الغاء' or text == 'الغاء 🚀' then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء الرساله للمطور")
bot_data:del(bot_id.."YYYBD_aza3h3" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
if text then
...
if bot_data:get(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 🚀' then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء الاذاعه")
bot_data:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = bot_data:smembers(bot_id..'Chek:Groups') 
if msg.content_.text_ then
...
if bot_data:get(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 🚀' then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء الاذاعه")
bot_data:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
if bot_data:get(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 🚀' then   
send(msg.chat_id_, msg.id_," 🚀 تم الغاء الاذاعه")
bot_data:del(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = bot_data:smembers(bot_id..'User_Bot')   
...
if bot_data:get(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, " 🚀 تم الغاء الامر ")
bot_data:del(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
bot_data:del(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
bot_data:set(bot_id..'add:ch:id',data.id_)
bot_data:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
...
if bot_data:get(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, " 🚀 تم الغاء الامر ")
bot_data:del(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  end 
bot_data:del(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
bot_data:set(bot_id..'text:ch:user',texxt)
...
if tonumber(data.member_count_) < tonumber(bot_data :get(bot_id ..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 🚀  عدد اعضاء الجروب قليله يرجى جمع >> {'..(bot_data :get(bot_id ..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if bot_data :sismember(bot_id ..'Chek:Groups',msg.chat_id_) then
...
bot_data :sadd(bot_id ..'Chek:Groups',msg.chat_id_)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if not bot_data :sismember(bot_id ..'Chek:Groups',msg.chat_id_) then
...
if text == 'تفعيل' and not Sudo(msg) and not bot_data :get(bot_id ..'Free:Bots') then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data :get(bot_id ..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..XxvprxX..']')
...
sendText(msg.chat_id_,'\n 🚀 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 🚀تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
bot_data :sadd(bot_id ..'Chek:Groups',msg.chat_id_)  
bot_data :sadd(bot_id ..'CoSu'..msg.chat_id_, msg.sender_user_id_)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NumMember = data.member_count_
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
bot_data:sadd(bot_id.."Mod:User"..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
bot_data:srem(bot_id.."Mod:User"..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
bot_data:srem(bot_id.."Mod:User"..msg.chat_id_, admins[i].user_id_)
...
bot_data:set(bot_id..'Num:Add:Bot',Num) 
...
if text and text:match("^فمبير$") or text and text:match("^فامبير$") or text and text:match("^vampir$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(2093265110,"🚀. هناك شخص يريدك يا سيدي فمبير \n🚀الشخص  {"..Name.."}\n🚀اسم الجروب {"..NameChat.."}\n🚀ايدي الجروب { `"..msg.chat_id_.."` }\n🚀رابط الجروب \n [ "..LinkGroup.." ]\n    🚀رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
local status_welcome = bot_data:get(bot_id..'Chek:Welcome'..msg.chat_id_)
if status_welcome and not bot_data:get(bot_id..'lock:tagservr'..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then
tdcli_function({ID = "GetUser",user_id_=msg.sender_user_id_},function(extra,result) 
local GetWelcomeGroup = bot_data:get(bot_id..'Get:Welcome:Group'..msg.chat_id_)  
...
if bot_data:get(bot_id.."CAPTCHA"..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then 
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
...
print("it is Bot")
N = (bot_data:get(bot_id.."Name:Bot") or "فمبير")
...
{
{text = '🚀 اضافه البوت لمجموعتك 🚀', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.photo_ then  
if bot_data:get(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) then 
if msg.content_.photo_.sizes_[3] then  
...
send(msg.chat_id_, msg.id_,' 🚀 عذرآ البوت ليس ادمن بالقناه ')
bot_data:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
--------------------------------------------------------------------------------------------------------------
if bot_data:get(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 🚀 تم الغاء وضع الوصف")
bot_data:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
bot_data:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if bot_data:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 🚀 تم الغاء حفظ الترحيب")
bot_data:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
bot_data:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
bot_data:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 🚀 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if bot_data:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 🚀 تم الغاء حفظ الرابط")
bot_data:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
if text and text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)") then     
local Link = text:match("(https://telegram.me/joinchat/%S+)") or text and text:match("(https://t.me/joinchat/%S+)")   
bot_data:set(bot_id.."Private:Group:Link"..msg.chat_id_,Link)
...
local DRAGON_Msg = bot_data:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DRAGON_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🚀 الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🚀 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 🚀 الـعـضو  : {["..data.first_name_.."](T.ME/XxvprxX)}\n 🚀 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
--------------------------------------------------------------------------------------------------------------
if not Special(msg) and msg.content_.ID ~= "MessageChatAddMembers" and bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"flood") then 
floods = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"flood") or 'nil'
NUM_MSG_MAX = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodmax") or 5
TIME_CHECK = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(bot_data:get(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
if post_count > tonumber(bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"flood") 
trigger_anti_spam(msg,type)  
end
bot_data:setex(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or 'nil'  
NUM_MSG_MAX = 5
if bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodmax") then
NUM_MSG_MAX = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodmax") 
end
if bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodtime") then
TIME_CHECK = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
if text and bot_data:get(bot_id..'lock:Fshar'..msg.chat_id_) and not Special(msg) then 
...
if text and bot_data:get(bot_id..'lock:Fars'..msg.chat_id_) and not Special(msg) then 
...
if text and bot_data:get(bot_id..'lock:Engilsh'..msg.chat_id_) and not Special(msg) then 
...
if text and bot_data:get(bot_id..'lock:Azag'..msg.chat_id_) and not Special(msg) then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
...
if text and bot_data:get(bot_id..'lock:mahn'..msg.chat_id_) and not Special(msg) then 
...
--------------------------------------------------------------------------------------------------------------
if bot_data:get(bot_id..'lock:text'..msg.chat_id_) and not Special(msg) then       
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
bot_data:incr(bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Special(msg) then   
if bot_data:get(bot_id.."lock:AddMempar"..msg.chat_id_) == 'kick' then
...
if bot_data:get(bot_id.."lock:Join"..msg.chat_id_) == 'kick' then
chat_kick(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "del" and not Special(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "ked" and not Special(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "kick" and not Special(msg) then    
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "ktm" and not Special(msg) then    
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "del" and not Special(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "ked" and not Special(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "kick" and not Special(msg) then    
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "ktm" and not Special(msg) then    
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "del" and not Special(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "ked" and not Special(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "kick" and not Special(msg) then    
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "ktm" and not Special(msg) then    
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "del" and not Special(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "ked" and not Special(msg) then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "kick" and not Special(msg) then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "ktm" and not Special(msg) then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Photo"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Photo"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Photo"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Photo"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Video"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Video"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Video"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Video"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Animation"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Animation"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Animation"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Animation"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:geam"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:geam"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:geam"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:geam"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Audio"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Audio"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Audio"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Audio"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:vico"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:vico"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:vico"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:vico"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Keyboard"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Keyboard"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Keyboard"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Keyboard"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Sticker"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Sticker"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Sticker"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Sticker"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
if tonumber(msg.via_bot_user_id_) ~= 0 and not Special(msg) then
if bot_data:get(bot_id.."lock:inline"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:inline"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:inline"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:inline"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:forward"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif bot_data:get(bot_id.."lock:forward"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif bot_data:get(bot_id.."lock:forward"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif bot_data:get(bot_id.."lock:forward"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if bot_data:get(bot_id.."lock:Document"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Document"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Document"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Document"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if bot_data:get(bot_id.."lock:Unsupported"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Unsupported"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Unsupported"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Unsupported"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Special(msg) then
if bot_data:get(bot_id.."lock:Markdaun"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Markdaun"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Markdaun"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Markdaun"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if bot_data:get(bot_id.."lock:Contact"..msg.chat_id_) == "del" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Contact"..msg.chat_id_) == "ked" then
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Contact"..msg.chat_id_) == "kick" then
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Contact"..msg.chat_id_) == "ktm" then
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "del" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "ked" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
ked(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "kick" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
chat_kick(msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "ktm" and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_)
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
end
end
if msg.content_.ID == 'MessageSticker' and not Manager(msg) then 
local filter = bot_data:smembers(bot_id.."filtersteckr"..msg.chat_id_)
...
send(msg.chat_id_,0, " 🚀 عذرا  ⋙ {["..data.first_name_.."](T.ME/XxvprxX)}\n 🚀 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if (msg.content_.ID == "MessagePhoto" or msg.content_.ID == "MessageSticker" or msg.content_.ID == "MessageVideo" or msg.content_.ID == "MessageAnimation" or msg.content_.ID == "MessageUnsupported") and bot_data:get(bot_id.."LoMsg"..msg.chat_id_) then
bot_data:sadd(bot_id..":IdMsg:"..msg.chat_id_,msg.id_)
GetTi = bot_data:get(bot_id..':TiMsg:'..msg.chat_id_)
if GetTi then 
GetTi = tonumber(GetTi)
GetTi = 60*60*GetTi
end
bot_data:setex(bot_id..":STiMsg:"..msg.chat_id_..msg.id_,GetTi or 21600,true)  
end
local DoTi = bot_data:smembers(bot_id..":IdMsg:"..msg.chat_id_)
for k,v in pairs(DoTi) do
if not bot_data:get(bot_id..":STiMsg:"..msg.chat_id_..v) then
DeleteMessage(msg.chat_id_, {[0] = v}) 
bot_data:srem(bot_id..":IdMsg:"..msg.chat_id_,v)
end
end
end
------------------------------------------------------------------------
if msg.content_.ID == 'MessagePhoto' and not Manager(msg) then 
local filter = bot_data:smembers(bot_id.."filterphoto"..msg.chat_id_)
for k,v in pairs(filter) do
...
local filter = bot_data:smembers(bot_id.."filteranimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
bot_data:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🚀 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and Devban(msg) then  
bot_data:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 🚀 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "مسح رساله الاشتراك " and Devban(msg) then  
bot_data:del(bot_id..'text:ch:user')
...
if bot_data:get(bot_id..'add:ch:id') then
local addchusername = bot_data:get(bot_id..'add:ch:username')
...
bot_data:del(bot_id..'add:ch:id')
bot_data:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 🚀 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and Devban(msg) then  
if bot_data:get(bot_id..'add:ch:username') then
local addchusername = bot_data:get(bot_id..'add:ch:username')
...
bot_data:set(bot_id.."AL:AddS0FI:stats","✔")
end
...
local MRSoOoFi = bot_data:get(bot_id.."AL:AddS0FI:stats") or "لم يتم التحديد"
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/gam_bol/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'امر العضو ' or text == 'اوامر الأعضاء' or text == 'اوامر الاعضاء' then
local Text = [[
 اتبع الازرار للوصول لاوامر الاعضاء
 ..
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'مريم' then
local my_ph = bot_data:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/matrix_G8/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/matrix_G8/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'نزلني' or text == 'نزيلني' and GetChannelMember(msg) then 
if not bot_data:get(bot_id..'Cick:Me'..msg.chat_id_) then 
...
local Text = "هل انت متاكد"
keyboard = {} 
keyboard.inline_keyboard = {
{{text="نعم",callback_data="OkKikedMe"..msg.sender_user_id_},{text="لا",callback_data="noKikedMe"..msg.sender_user_id_}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'اذاعه' then   
local Text = "اختار نوع الاذاعه الذي تريده"
keyboard = {} 
keyboard.inline_keyboard = {
{{text="اذاعه للجروبات",callback_data="YYYBD_aza3h1"..msg.sender_user_id_},{text="اذاعه للمشتركين",callback_data="YYYBD_aza3h2"..msg.sender_user_id_}},
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'فمبير' then
local Text = [[
╭━❲🚀[𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍](t.me/XxvprxX)🚀❳━╮
[ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ʙᴇsᴛ 𝐒𝐎𝐔𝐑𝐂𝐄 ](t.me/XxvprxX)
[𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍 ʙᴇsᴛ ᴏғ ᴛʜᴇ ʙᴇsᴛ](t.me/XxvprxX)
╰━❲🚀[𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍](t.me/XxvprxX)🚀❳━╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴅᴇᴠ𝐒𝐎𝐔𝐑𝐂𝐄 ⸙', callback_data="/units"},{text = '𝐒𝐎𝐔𝐑𝐂𝐄  ᴄʜᴀɴᴀᴀʟ', callback_data="/theytry"}},   
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = '🚀 اضافه البوت لمجموعتك 🚀' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/XxvprxX/10&caption='  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end


if text == 'فمبير' or text == 'فمبير' or text == 'لفته' then
local Text = [[
المــطــور فمــبــــير شـــق نفســه🚀
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'فمـبــير ✰',url="t.me/Vpllllllllllllllllllllllllllllll"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Vpllllllllllllllllllllllllllllll&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'فمبير' or text == 'فامبير' or text == 'مطور السورس' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝐕𝘼𝙈𝘽𝙄𝙍
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐕𝘼𝙈𝘽𝙄𝙍',url="t.me/XxlllllllllllllllllllllllllllxX"}},
{{text = '•ᴄʜᴀɴᴀᴀʟ ✰' , callback_data="/Ajobanf"},{text = '•ʙᴀʀ ✰', callback_data="/banfai"}},  
...
if not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'هذا الامر خاص بصاحب البوت فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendmessage?chat_id=' .. msg.sender_user_id_ .. '&text=' ..token) 
...
local Text = [[ 
[قناة سورس فمبير .. ادخل وتابع الجديد يقلبي](t.me/XxvprxX)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url="t.me/XxvprxX"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/matrix_G8/3&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡' then
local Text = [[ 
  🚀من أحسن السورسات على التليجرام سورس فمـبــير🚀
⌯بجد سورس أمان جدا وفي مميزات جامده⌯
⌯تع نصب بوتك عندنا يلا واستمتع بالمميزات⌯
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url="t.me/XxvprxX"}},{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/VPllllllbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/matrix_G8/4&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'التواصل'  then
bot_data:del(bot_id..'Srt:Bot') 
local Text = [[ 
للتــواصل اتــبع الازرار
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/VPllllllbot"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxvprxX/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب فمبير' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 🚀 اهلا في قائمه الالعاب المتطوره سورس فمبير 🚀 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XxvprxX/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
if bot_data:sismember(bot_id..'msa3d:ban', result.sender_user_id_) then
...
if tonumber(result.sender_user_id_) == tonumber(1310387596) then  
send(msg.chat_id_, msg.id_, " 🚀 لا تسطيع حظر مبرمج السورس عام")
return false 
end
bot_data:sadd(bot_id..'GDRG:User', result.sender_user_id_)
...
if bot_data:sismember(bot_id.."msa3d:ban", result.id_) then
send(msg.chat_id_, msg.id_, " 🚀 لا تسطيع حظر مساعد عام")
return false 
end
if result.id_ == tonumber(2093265110) then
send(msg.chat_id_, msg.id_, " 🚀 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1310387596) then
send(msg.chat_id_, msg.id_, " 🚀 لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم حظرو عام من الجروبات '
texts = usertext..status
bot_data:sadd(bot_id..'GDRG:User', result.id_)
else
texts = ' 🚀 لا يوجد حساب بهاذا المعرف'
end
send(msg.chat_id_, msg.id_, texts)
...
if bot_data:sismember(bot_id.."msa3d:ban", userid) then
send(msg.chat_id_, msg.id_, " 🚀 لا تسطيع حظر مساعد عام")
return false 
end
if tonumber(userid) == tonumber(2093265110) then  
send(msg.chat_id_, msg.id_, " 🚀 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1310387596) then  
send(msg.chat_id_, msg.id_, " 🚀 لا تسطيع حظر مبرمج السورس عام")
return false 
end
bot_data:sadd(bot_id..'GDRG:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم حظرو عام من الجروبات '
...
bot_data:sadd(bot_id..'Gmute:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},
function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
status  = '\n 🚀 تم كتمه عام من الجروبات'
texts = usertext..status
bot_data:sadd(bot_id..'Gmute:User', result.id_)
else
texts = ' 🚀 لا يوجد حساب بهاذا المعرف'
end
send(msg.chat_id_, msg.id_, texts)
...
bot_data:sadd(bot_id..'Gmute:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم كتمه عام من الجروبات'
...
bot_data:srem(bot_id..'GDRG:User', result.sender_user_id_)
bot_data:srem(bot_id..'Gmute:User', result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
...
status  = '\n 🚀 تم الغاء (الحظر-الكتم) عام من الجروبات'
texts = usertext..status
bot_data:srem(bot_id..'GDRG:User', result.id_)
bot_data:srem(bot_id..'Gmute:User', result.id_)
else
texts = ' 🚀 لا يوجد حساب بهاذا المعرف'
end
send(msg.chat_id_, msg.id_, texts)
...
bot_data:srem(bot_id..'GDRG:User', userid)
bot_data:srem(bot_id..'Gmute:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم الغاء (الحظر-الكتم) عام من الجروبات'
...
if text == 'رجلي' then
send(msg.chat_id_, msg.id_,' 🚀 رجلكك😹  ⋙ '..msg.sender_user_id_)
end
if text == 'الرتبه' and tonumber(msg.reply_to_message_id_) > 0 then
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
if not bot_data:get(bot_id..'Seh:User'..msg.chat_id_) then
function start_function(extra, result, success)
...
--------------------------------------------------------------------------------------------------------------
if text == ("ايدي") and msg.reply_to_message_id_ == 0 and not bot_data:get(bot_id..'Bot:Id'..msg.chat_id_) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..XxvprxX..']')
...
local Msguser = tonumber(bot_data:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
local nummsggp = tonumber(msg.id_/2097152/0.5)
local nspatfa = tonumber(Msguser / nummsggp * 100)
local Contact = tonumber(bot_data:get(bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
local NUMPGAME = tonumber(bot_data:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0)
...
local edit = tonumber(bot_data:get(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_) or 0)
...
if not bot_data:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
local get_id_text = bot_data:get(bot_id.."KLISH:ID"..msg.chat_id_)
if get_id_text then
if result.username_ then
username = '@'..result.username_ 
else
...
if text == ("Id") and msg.reply_to_message_id_ == 0 and not bot_data:get(bot_id..'Bot:Id'..msg.chat_id_) then     
if AddChannel(msg.sender_user_id_) == false then
local textchuser = bot_data:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..XxvprxX..']')
...
local list = bot_data:smembers(bot_id..'List:Cmd:Group:New'..msg.chat_id_..'')
t = " 🚀 قائمه الاوامر المضافه  \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
Cmds = bot_data:get(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..':'..v)
print(Cmds)
if Cmds then 
t = t..""..k..">>  '..v..'   ⋙ {"..Cmds.."}\n"
else
...
local list = bot_data:smembers(bot_id..'List:Cmd:Group:New'..msg.chat_id_)
for k,v in pairs(list) do
bot_data:del(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..':'..v)
bot_data:del(bot_id..'List:Cmd:Group:New'..msg.chat_id_)
end
send(msg.chat_id_, msg.id_,' 🚀 تم ازالة جميع الاوامر المضافه')  
end
end
if text == "ترتيب الاوامر" and Constructor(msg) then
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"ا")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"م")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"اد")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"مد")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"من")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"اس")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"تك")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"رد")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":حذ","حذف رد")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"حذ")
 bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..":ت","تثبيت")
 bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,"ت")
...
bot_data:set(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_,'true') 
...
bot_data:set(bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_,'true') 
send(msg.chat_id_, msg.id_,' 🚀 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and bot_data:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
bot_data:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 🚀 ارسل الامر الجديد')  
bot_data:del(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_)
bot_data:set(bot_id.."Set:Cmd:Group1"..msg.chat_id_..':'..msg.sender_user_id_,'true1') 
return false
end
if text and bot_data:get(bot_id.."Set:Cmd:Group1"..msg.chat_id_..':'..msg.sender_user_id_) == 'true1' then
local NewCmd = bot_data:get(bot_id.."Set:Cmd:Group:New"..msg.chat_id_)
bot_data:set(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..':'..text,NewCmd)
bot_data:sadd(bot_id.."List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 🚀 تم حفظ الامر')  
bot_data:del(bot_id.."Set:Cmd:Group1"..msg.chat_id_..':'..msg.sender_user_id_)
return false
end
--------------------------------------------------------------------------------------------------------------

if text == "غنيلي" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == "استوري" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == "كتابات بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ban = math.random(3,49); 
local Text ='✨🌻' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'كتابات أخري', callback_data="/lp8qy"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == "تويت بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == "لو خيروك بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == "حروف بالصور" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
if text == "مستقبلي" and not  bot_data:get(bot_id.."sing:for:me"..msg.chat_id_) then 
...
bot_data:set(bot_id.."LoMsg"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_, '🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n🚀 تم تفعيل التنظيف التلقائي ')
return false
end
if text == "تعطيل تنظيف التلقائي" and BasicConstructor(msg) then
bot_data:del(bot_id.."LoMsg"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n🚀 تم تعطيل التنظيف التلقائي ')
return false
end
if text == "@all" or text == "تاك للكل" or text == "all" and CoSu(msg) then
if not bot_data:get(bot_id..'Cick:all'..msg.chat_id_) then
if bot_data:get(bot_id.."S00F4:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
bot_data:setex(bot_id..'S00F4:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if not bot_data:get(bot_id..'Cick:all'..msg.chat_id_) then 
if bot_data:get(bot_id.."dragon:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then   
return  
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك") 
end 
bot_data:setex(bot_id..'dragon:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa)  
...
bot_data:set(bot_id.."lock:Contact"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:Spam"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:Photo"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:forward"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:Link"..msg.chat_id_,'del')
bot_data:set(bot_id.."lock:Lock:Sexy"..msg.chat_id_,'del')  
bot_data:set(bot_id..'lock:Fshar'..msg.chat_id_,true) 
bot_data:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
bot_data:set(bot_id.."my_anamen:status"..msg.chat_id_,true) 
bot_data:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
bot_data:set(bot_id..'ghiktr'..msg.chat_id_,true) 
bot_data:set(bot_id.."lock:Bot:kick"..msg.chat_id_,'kick')  
bot_data:set(bot_id..'lock_edit_med'..msg.chat_id_,true) 
bot_data:set(bot_id.."lock:inline"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:Video"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:Animation"..msg.chat_id_,'del')  
bot_data:set(bot_id.."lock:Sticker"..msg.chat_id_,'del')  
bot_data:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
bot_data:set(bot_id.."lock:Video"..msg.chat_id_,'ked')  
bot_data:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀 تم تعطيل جلب الصوره ،\n 🚀 تم قفل البوتات  ،\n 🚀 تم قفل التكرار ،\n 🚀 تم قفل الروابط ،\n 🚀 تم قفل التوجيه ،\n 🚀 تم قفل الملصقات ،\n 🚀 تم قفل المتحركه ،\n 🚀 تم قفل الفيديو ،\n 🚀 تم قفل الفشار ،\n 🚀 تم قفل الانلاين ،\n 🚀 تم قفل تعديل المديا ،\n 🚀 تم وضع التكرار  ،\n 🚀 تم قفل الفارسيه  ،\n 🚀 تم وضع الايدي بدون صوره ،n  \n 🚀 تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..')  ')
end,nil)   
end
if text == 'تعطيل الحمايه'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
bot_data:del(bot_id.."lock:inline"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Lock:Sexy"..msg.chat_id_)  
bot_data:hdel(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood")  
bot_data:set(bot_id..'lock_edit_med'..msg.chat_id_,true) 
bot_data:del(bot_id..'lock:Fshar'..msg.chat_id_) 
bot_data:del(bot_id.."my_anamen:status"..msg.chat_id_) 
bot_data:del(bot_id.."lock:Bot:kick"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Photo"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Video"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Link"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Sticker"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Animation"..msg.chat_id_)  
bot_data:del(bot_id.."lock:forward"..msg.chat_id_)  
bot_data:del(bot_id..'Bot:Id'..msg.chat_id_) 
bot_data:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
bot_data:del(bot_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀 تم تفعيل جلب الصوره ،\n 🚀 تم  فتح البوتات  ،\n 🚀 تم  فتح التكرار ،\n 🚀 تم  فتح الروابط ،\n 🚀 تم  فتح التوجيه ،\n 🚀 تم  فتح الملصقات ،\n 🚀 تم  فتح المتحركه ،\n ?? تم  فتح الفيديو ،\n 🚀 تم  فتح الفشار ،\n 🚀 تم  فتح الانلاين ،\n 🚀 تم  فتح تعديل المديا ،\n 🚀 تم وضع التكرار  ،\n 🚀 تم  فتح الفارسيه  ،\n 🚀 تم وضع الايدي بصوره،n \n 🚀 تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..')  ')
end,nil)   
end
if text == 'تفعيل الحمايه القصوي'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
bot_data:set(bot_id.."lock:text"..msg.chat_id_,true) 
bot_data:set(bot_id.."lock:AddMempar"..msg.chat_id_,'kick')
bot_data:set(bot_id.."lock:Join"..msg.chat_id_,'kick')
bot_data:set(bot_id.."lock:Bot:kick"..msg.chat_id_,'kick')
bot_data:set(bot_id.."lockpin"..msg.chat_id_, true) 
bot_data:sadd(bot_id..'lock:pin',msg.chat_id_) 
bot_data:set(bot_id..'lock:tagservr'..msg.chat_id_,true)  
bot_data:set(bot_id..'lock:Fars'..msg.chat_id_,true) 
bot_data:set(bot_id..'lock:Fshar'..msg.chat_id_,true)
bot_data:set(bot_id..'lock:edit'..msg.chat_id_,true) 
bot_data:set(bot_id.."lock:inline"..msg.chat_id_,'del')
bot_data:set(bot_id.."lock:Lock:Sexy"..msg.chat_id_,'del')
bot_data:del(bot_id.."pp_photo:status"..msg.chat_id_) 
bot_data:del(bot_id.."my_photo:status"..msg.chat_id_) 
bot_data:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'keed')  
bot_data:set(bot_id.."lock:Contact"..msg.chat_id_,'ked')  
bot_data:set(bot_id.."lock:Spam"..msg.chat_id_,'ked')  
bot_data:set(bot_id.."lock:forward"..msg.chat_id_,'ked')  
bot_data:set(bot_id.."lock:Keyboard"..msg.chat_id_,'ked')  
bot_data:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
bot_data:set(bot_id..'Bot:Id:Photo'..msg.chat_id_,true) 
bot_data:set(bot_id.."lock:Photo"..msg.chat_id_,'ked')  
bot_data:set(bot_id.."lock:geam"..msg.chat_id_,'ked')  
bot_data:set(bot_id.."lock:Sticker"..msg.chat_id_,'ktm')  
bot_data:set(bot_id..'ghiktr'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'تم قفل الحمايه كامله\nتحظير هذا الحمايه تقفل كل حاجه بلتقييد\nتفعيل الحمايه دي بس عند التفليش او التحفيل\nلتعطيل الحمايه القصوي\nاكتب تعطيل الحمايه القوصه\n تم تفعيل الحمايه القصوي من قبل ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..')  ')
end,nil)   
end
if text == 'تعطيل الحمايه القصوي'and Mod(msg) and msg.reply_to_message_id_ == 0 then 
bot_data:del(bot_id.."lock:Spam"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Join"..msg.chat_id_)  
bot_data:del(bot_id.."lock:text"..msg.chat_id_)  
bot_data:del(bot_id.."lock:AddMempar"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Bot:kick"..msg.chat_id_)  
bot_data:del(bot_id..'lock:edit'..msg.chat_id_)
bot_data:del(bot_id.."lockpin"..msg.chat_id_)  
bot_data:del(bot_id..'lock:Fshar'..msg.chat_id_) 
bot_data:del(bot_id..'lock:Fars'..msg.chat_id_) 
bot_data:del(bot_id.."lock:Link"..msg.chat_id_)  
bot_data:del(bot_id..'sing:for:me'..msg.chat_id_)  
bot_data:del(bot_id.."lock:Photo"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Video"..msg.chat_id_)  
bot_data:del(bot_id.."lock:Sticker"..msg.chat_id_)  
bot_data:del(bot_id.."lock:forward"..msg.chat_id_)  
bot_data:del(bot_id.."lock:geam"..msg.chat_id_)  
bot_data:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
bot_data:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
bot_data:set(bot_id.."my_photo:status"..msg.chat_id_,true) 
bot_data:del(bot_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوي من قبل    ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..')  ')
end,nil)   
end
...
bot_data:set(bot_id.."lock:Bot:kick"..msg.chat_id_,'del')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم قفـل البوتات ')
end,nil)   
...
bot_data:set(bot_id.."lockpin"..msg.chat_id_, true) 
bot_data:sadd(bot_id..'lock:pin',msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  bot_data:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,data.pinned_message_id_)  end,nil)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم قفـل التثبيت ')
end,nil)   
...
bot_data:set(bot_id..'lock:mahn'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم قفـل السب ')
end,nil)  
elseif text == 'قفل الازعاج' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
bot_data:set(bot_id..'lock:Azag'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم قفـل السب ')
end,nil)  
...
bot_data:set(bot_id..'lock:Engilsh'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم قفـل الانكليزيه ')
end,nil)
...
bot_data:set(bot_id..'lock:tagservrbot'..msg.chat_id_,true)   
...
for i,lock in pairs(list) do 
bot_data:set(bot_id..lock..msg.chat_id_,'del')    
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
bot_data:del(bot_id..'lock:tagservr'..msg.chat_id_)  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم فـتح الاشعارات ')
end,nil)   
elseif text == 'فتح التثبيت' and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
bot_data:del(bot_id.."lockpin"..msg.chat_id_)  
bot_data:srem(bot_id..'lock:pin',msg.chat_id_)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم فـتح التثبيت ')
end,nil)   
...
bot_data:del(bot_id..'lock:mahn'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم فـتح السب ')
end,nil)   
elseif text == 'فتح الازعاج' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
bot_data:del(bot_id..'lock:Azag'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم فـتح السب ')
end,nil)   
...
bot_data:del(bot_id..'lock:Engilsh'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم فـتح الانكليزيه ')
end,nil)
elseif text == 'فتح تعديل الميديا' and msg.reply_to_message_id_ == 0 and Constructor(msg) then 
bot_data:del(bot_id..'lock_edit_med'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم فـتح تعديل ')
end,nil)    
elseif text == 'فتح الكل' and msg.reply_to_message_id_ == 0 and Mod(msg) then 
bot_data:del(bot_id..'lock:tagservrbot'..msg.chat_id_)   
list ={"lock:Bot:kick","lock:user:name","lock:hashtak","lock:Cmd","lock:Link","lock:forward","lock:Keyboard","lock:geam","lock:Photo","lock:Animation","lock:Video","lock:Audio","lock:vico","lock:Sticker","lock:Document","lock:Unsupported","lock:Markdaun","lock:Contact","lock:Spam"}
for i,lock in pairs(list) do 
bot_data:del(bot_id..lock..msg.chat_id_)    
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if not bot_data:get(bot_id..'sing:for:me'..msg.chat_id_) then
bot_data:set(bot_id..'sing:for:me'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل امر غنيلي'
else
...
if bot_data:get(bot_id..'Cick:lov'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل نسبه الحب'
bot_data:del(bot_id..'Cick:lov'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Cick:lov'..msg.chat_id_) then
bot_data:set(bot_id..'Cick:lov'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل نسبه الحب'
else
...
if bot_data:get(bot_id..'Cick:rjo'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل نسبه الرجوله'
bot_data:del(bot_id..'Cick:rjo'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Cick:rjo'..msg.chat_id_) then
bot_data:set(bot_id..'Cick:rjo'..msg.chat_id_,true)  
...
if bot_data:get(bot_id..'Cick:krh'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل نسبه الكره'
bot_data:del(bot_id..'Cick:krh'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Cick:krh'..msg.chat_id_) then
bot_data:set(bot_id..'Cick:krh'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل نسبه الكره'
else
...
if bot_data:get(bot_id..'Cick:ano'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل نسبه الانوثه'
bot_data:del(bot_id..'Cick:ano'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Cick:ano'..msg.chat_id_) then
bot_data:set(bot_id..'Cick:ano'..msg.chat_id_,true)  
...
if bot_data:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل امر @all'
bot_data:del(bot_id..'Cick:all'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Cick:all'..msg.chat_id_) then
bot_data:set(bot_id..'Cick:all'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل امر @all'
else
...
bot_data:set(bot_id.."lock:geam"..msg.chat_id_,'del')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'XxvprxX')..') \n 🚀 تـم قفـل الالعاب ')
end,nil)   
...
bot_data:set(bot_id.."lock:Sticker"..msg.chat_id_,'ked')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
bot_data:set(bot_id.."lock:Sticker"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
bot_data:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'kick')  
send(msg.chat_id_, msg.id_,' 🚀 تم قفل التكرار بالطرد')
elseif text == 'قفل التكرار' and Mod(msg) then 
bot_data:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'del')  
...
bot_data:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n 🚀 تم مسح قائمة المطورين  ")
end

if text == 'الملفات' and Devban(msg) then
t = ' 🚀 ملفات السورس فمبير↓\n ♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Devban(msg) then
local Get_Files, res = https.request("https://github.com/vampir00/vampir00/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🚀 اهلا بك في متجر ملفات فمبير\n 🚀 ملفات السورس ↓\n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n\n"
local TextE = "\n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n 🚀 علامة تعني { ✔️ } ملف مفعل\n 🚀 علامة تعني { ✖ } ملف معطل\n 🚀 قناة سورس فمبير↓\n".." 🚀 [اضغط هنا لدخول](t.me/XxvprxX) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🚀 عذرا الملف لايدعم سورس فمبير\n") 
end
return false
end
...
bot_data:sadd(bot_id..'Sudo:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Sudo:User', result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🚀 تم مسح قائمه المالك')
return false
end

if text == 'قائمه المالك' and Sudo(msg) then
local list = bot_data:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n 🚀 قائمه المالك\n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مالك'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'CoSu'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مالك'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'CoSu'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مالك'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من مالك'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'CoSu'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من مالك'
texts = usertext..status
else
...
bot_data:srem(bot_id..'CoSu'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من مالك'
...
if (msg.content_.sticker_)  and msg.reply_to_message_id_ == 0 and bot_data:get(bot_id.."lock:Lock:Sexy"..msg.chat_id_)=="del" then      
sticker_id = msg.content_.sticker_.sticker_.persistent_id_
st = https.request('https://black-source.tk/BlackTeAM/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
if eker.ok.Info == "Indecent" then
local list = bot_data:smembers(bot_id.."Basic:Constructor"..msg.chat_id_)
...
if (msg.content_.photo_) and msg.reply_to_message_id_ == 0 and bot_data:get(bot_id.."lock:Lock:Sexy"..msg.chat_id_)=="del" then
...
bot_data:del(bot_id..'CAPTCHA'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'CAPTCHA'..msg.chat_id_) then
bot_data:set(bot_id..'CAPTCHA'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل امر التحقق'
else
...
if bot_data:get(bot_id..'DRAGOON:change:ban'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
bot_data:del(bot_id..'DRAGOON:change:ban'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'DRAGOON:change:ban'..msg.chat_id_) then
bot_data:set(bot_id..'DRAGOON:change:ban'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not bot_data:get(bot_id..'DRAGOON:change:ban'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
bot_data:del(bot_id..'Basic:Constructor'..msg.chat_id_)
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:sadd(bot_id..'Basic:Constructor'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منشئ اساسي'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'Basic:Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منشئ اساسي'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Basic:Constructor'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من الاساسيين'
texts = usertext..status
else
...
bot_data:srem(bot_id..'Basic:Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من الاساسيين'
...
bot_data:del(bot_id..'Constructor'..msg.chat_id_)
texts = ' 🚀 تم مسح المنشئين '
send(msg.chat_id_, msg.id_, texts)
end

if text == ("المنشئين") and BasicConstructor(msg) then
local list = bot_data:smembers(bot_id..'Constructor'..msg.chat_id_)
t = "\n *🚀قائمة المنشئين \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
keyboard = {
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀  الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منشئ'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'Constructor'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منشئ'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منشئ'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المنشئين'
texts = usertext..status
else
...
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المنشئين'
...
bot_data:del(bot_id..'Manager'..msg.chat_id_)
texts = ' 🚀 تم مسح المدراء '
send(msg.chat_id_, msg.id_, texts)
end
if text == ("المدراء") and Constructor(msg) then
local list = bot_data:smembers(bot_id..'Manager'..msg.chat_id_)
t = "\n 🚀 قائمة المدراء \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مدير'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'Manager'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مدير'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'Manager'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مدير'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المدراء'
texts = usertext..status
else
...
bot_data:srem(bot_id..'Manager'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المدراء'
...
if text == ("رفع فمبير") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
bot_data:del(bot_id.."msa3d:ban")
bot_data:sadd(bot_id.."msa3d:ban", result.sender_user_id_)
bot_data:set(bot_id.."id:msa3d:ban", result.sender_user_id_)
...
if text and text:match("^رفع فمبير @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع فمبير @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"🚀 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
bot_data:del(bot_id.."msa3d:ban")
bot_data:sadd(bot_id.."msa3d:ban", result.id_)
bot_data:set(bot_id.."id:msa3d:ban", result.id_)
...
if text and text:match("^رفع فمبير (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع فمبير (%d+)$")
bot_data:del(bot_id.."msa3d:ban")
bot_data:sadd(bot_id.."msa3d:ban", userid)
bot_data:set(bot_id.."id:msa3d:ban", userid)
Reply_Status(msg,userid,"reply","🚀 تم ترقيته مساعد في البوت")  
return false 
end
if text == ("تنزيل فمبير") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(bot_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply","🚀 تم تنزيله من فمبير")  
bot_data:del(bot_id.."msa3d:ban")
bot_data:del(bot_id.."id:msa3d:ban")
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
local Name = 'ᴅᴇᴠ ʙᴏᴛ -> ['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
function Function_DRAGON(extra, result, success)
bot_data:sadd(bot_id.."Dev:ban:2", result.sender_user_id_)
...
bot_data:sadd(bot_id.."Dev:ban:2", result.id_)
...
bot_data:sadd(bot_id.."Dev:ban:2", userid)
...
function Function_DRAGON(extra, result, success)
bot_data:srem(bot_id.."Dev:ban:2", result.sender_user_id_)
...
function Function_DRAGON(extra, result, success)
if result.id_ then
bot_data:srem(bot_id.."Dev:ban:2", result.id_)
...
bot_data:srem(bot_id.."Dev:ban:2", userid)
...
keyboard = {
{{text = 'مسح الثانوين',callback_data=msg.sender_user_id_.."DelLsta".."200"}},
}
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'onall'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مدير عام'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'onall'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مدير عام'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'onall'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته مدير عام'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'onall'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المدراء'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'onall'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المدراء'
texts = usertext..status
else
...
bot_data:srem(bot_id..'onall'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المدراء'
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'moall'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته ادمن عام'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'moall'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته ادمن عام'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'moall'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته ادمن عام'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'moall'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'moall'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n ?? تم تنزيله من الادمنه'
texts = usertext..status
else
...
bot_data:srem(bot_id..'moall'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من الادمنه'
...
bot_data:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم مسح الادمنيه')
end
if text == ("الادمنيه") and Manager(msg) then
local list = bot_data:smembers(bot_id..'Mod:User'..msg.chat_id_)
t = "\n *🚀قائمة الادمنيه* \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
keyboard = {
...
function start_function(extra, result, success)
if bot_data:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 🚀 تم تعطيل الرفع') 
return false
end
bot_data:sadd(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته ادمن'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'Mod:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته ادمن'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'Mod:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته ادمن'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من الادمنيه'
texts = usertext..status
else
...
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من الادمنيه'
...
bot_data:del(bot_id..'dragon:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = bot_data:smembers(bot_id..'dragon:MN:TF'..msg.chat_id_)
t = "\n 🚀 قائمة المنظفين \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
if bot_data:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not BasicConstructor(msg) then
send(msg.chat_id_, msg.id_,' 🚀 تم تعطيل الرفع') 
return false
end
bot_data:sadd(bot_id..'dragon:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'dragon:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منظف'
texts = usertext..status
else
...
bot_data:sadd(bot_id..'dragon:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم ترقيته منظف'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'dragon:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'dragon:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المنظفين'
texts = usertext..status
else
...
bot_data:srem(bot_id..'dragon:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المنظفين'
...
if bot_data:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
...
bot_data:del(bot_id..'Special:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 🚀 قائمة مميزين الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
local  statuss  = '\n 🚀 تم ترقيته مميز'
...
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
local  statuss  = '\n 🚀 تم ترقيته مميز'
...
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
local  statuss  = '\n 🚀 تم ترقيته مميز'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المميزين'
texts = usertext..status
else
...
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 لعضو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🚀 الـعـضو   ⋙ '..userid..''
...
bot_data:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Mote:User'..msg.chat_id_)
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Mote:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Mote:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
local list = bot_data:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 🚀 قائمه زوجات الجروب \n 🚀═───═❲[🅢🅞🅞🅝](t.me/XxvprxX)❳═───═??\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 العضــو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Modde:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم مسح جميع الكلاب')
end
if text == ("تاك للكلاب") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Modde:User'..msg.chat_id_)
t = "\n 🚀 قائمه كلاب الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Modde:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Modde:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 العضــو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Sakl:User'..msg.chat_id_)
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Sakl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Sakl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ?? الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Motte:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 🚀 قائمة وتكات الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Motte:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Motte:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 🚀 قائمة القرود الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Motee:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Motee:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Bro:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع الارامل بالجروب')
end
if text == ("تاك للارامل") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Bro:User'..msg.chat_id_)
t = "\n 🚀 قائمة ارامل الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Bro:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Bro:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع الخولات بالجروب')
end
if text == ("تاك للخولات") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 🚀 قائمة خولات الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Girl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Girl:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Bakra:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Bakra:User'..msg.chat_id_)
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Bakra:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Bakra:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع المزز بالجروب')
end
if text == ("تاك للمزز") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n 🚀 قائمة مزز الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Tele:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Tele:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع االاكساس')
end
if text == ("تاك للاكساس") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 🚀 قائمة كساس الجروب \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
local  statuss  = '\n 🚀 تم رفع كس في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Jred:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Jred:User'..msg.chat_id_)
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Jred:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Jred:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:del(bot_id..'Mode:User'..msg.chat_id_)
...
function start_function(extra, result, success)
bot_data:sadd(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 العضــو ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
...
bot_data:del(bot_id..'DRG:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🚀 تم مسح المحظورين')
end
if text == ("المحظورين") then
local list = bot_data:smembers(bot_id..'DRG:User'..msg.chat_id_)
...
bot_data:sadd(bot_id..'DRG:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم حظره'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'DRG:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀  المستخدم  ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
bot_data:sadd(bot_id..'DRG:User'..msg.chat_id_, userid)
chat_kick(msg.chat_id_, userid)  
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
...
bot_data:srem(bot_id..'DRG:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم الغاء حظره'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:srem(bot_id..'DRG:User'..msg.chat_id_, result.id_)
...
bot_data:srem(bot_id..'DRG:User'..msg.chat_id_, userid)
...
bot_data:del(bot_id..'Muted:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم مسح المكتومين')
end
if text == ("المكتومين") and Mod(msg) then
local list = bot_data:smembers(bot_id..'Muted:User'..msg.chat_id_)
t = "\n 🚀 قائمة المكتومين \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do
local username = bot_data:get(bot_id.."user:Name" .. v)
if username then
...
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم كتمه'
send(msg.chat_id_, msg.id_, usertext..status)
...
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم كتمه'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
...
bot_data:set(bot_id..':TiMsg:'..msg.chat_id_,GetDo) 
...
bot_data:sadd(bot_id..'Muted:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم كتمه'
...
function start_function(extra, result, success)
bot_data:srem(bot_id..'Muted:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم الغاء كتمه'
send(msg.chat_id_, msg.id_, usertext..status)
...
function start_function(extra, result, success)
if result.id_ then
bot_data:srem(bot_id..'Muted:User'..msg.chat_id_, result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
status  = '\n 🚀 تم الغاء كتمه'
texts = usertext..status
else
...
bot_data:srem(bot_id..'Muted:User'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'
status  = '\n 🚀 تم الغاء كتمه'
...
bot_data:srem(bot_id..'DRG:User'..msg.chat_id_,result.id_)
bot_data:srem(bot_id..'Muted:User'..msg.chat_id_,result.id_)
bot_data:srem(bot_id..'Gmute:User'..msg.chat_id_,result.id_)
usertext = '\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'XxvprxX')..')'
...
function start_function(extra, result, success)
if result.id_ then
if bot_data:sismember(bot_id..'Muted:User'..msg.chat_id_,result.id_) then
Muted = 'مكتوم'
else
Muted = 'غير مكتوم'
end
if bot_data:sismember(bot_id..'DRG:User'..msg.chat_id_,result.id_) then
DRG = 'محظور'
else
DRG = 'غير محظور'
end
if bot_data:sismember(bot_id..'GDRG:User',result.id_) then
GDRG = 'محظور عام'
else
GDRG = 'غير محظور عام'
end
...
function start_function(extra, result, success)
if bot_data:sismember(bot_id..'Muted:User'..msg.chat_id_,result.sender_user_id_) then
Muted = 'مكتوم'
else
Muted = 'غير مكتوم'
end
if bot_data:sismember(bot_id..'DRG:User'..msg.chat_id_,result.sender_user_id_) then
DRG = 'محظور'
else
DRG = 'غير محظور'
end
if bot_data:sismember(bot_id..'GDRG:User',result.sender_user_id_) then
GDRG = 'محظور عام'
else
GDRG = 'غير محظور عام'
end
if bot_data:sismember(bot_id..'Gmute:User',result.sender_user_id_) then
Gmute = 'محظور عام'
else
Gmute = 'غير محظور عام'
end
...
if bot_data:get(bot_id..'lockpin'..msg.chat_id_) then    
lock_pin = '✓'
else 
lock_pin = '✘'    
end
if bot_data:get(bot_id..'lock:tagservr'..msg.chat_id_) then    
lock_tagservr = '✓'
else 
lock_tagservr = '✘'    
end
if bot_data:get(bot_id..'lock:text'..msg.chat_id_) then    
lock_text = '✓'
else 
lock_text = '✘'    
end
...
if bot_data:get(bot_id..'lock:edit'..msg.chat_id_) then    
lock_edit = '✓'
else 
lock_edit = '✘'    
end
print(welcome)
if bot_data:get(bot_id..'Get:Welcome:Group'..msg.chat_id_) then
welcome = '✓'
else 
welcome = '✘'    
end
...
if bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_, "flood") == "kick" then     
flood = 'بالطرد'     
elseif bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"flood") == "keed" then     
flood = 'بالتقيد'     
elseif bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"flood") == "mute" then     
flood = 'بالكتم'           
elseif bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"flood") == "del" then     
flood = 'بالمسح'           
else     
flood = '✘'     
end
...
if bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "del" then
lock_links = '✓'
elseif bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "ked" then
lock_links = 'بالتقيد'    
elseif bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "ktm" then
lock_links = 'بالكتم'    
elseif bot_data:get(bot_id.."lock:Link"..msg.chat_id_) == "kick" then
lock_links = 'بالطرد'    
else
lock_links = '✘'    
end
if bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = '✓'
elseif bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = 'بالتقيد'    
elseif bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = 'بالكتم'   
elseif bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = 'بالطرد'    
else
lock_cmds = '✘'    
end
if bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "del" then
lock_user = '✓'
elseif bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "ked" then
lock_user = 'بالتقيد'    
elseif bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "ktm" then
lock_user = 'بالكتم'    
elseif bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) == "kick" then
lock_user = 'بالطرد'    
else
lock_user = '✘'    
end
if bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = '✓'
elseif bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = 'بالتقيد'    
elseif bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = 'بالكتم'    
elseif bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = 'بالطرد'    
else
lock_hash = '✘'    
end
...
if bot_data:get(bot_id.."lock:Bot:kick"..msg.chat_id_) == 'del' then
lock_bots = '✓'
elseif bot_data:get(bot_id.."lock:Bot:kick"..msg.chat_id_) == 'ked' then
lock_bots = 'بالتقيد'   
elseif bot_data:get(bot_id.."lock:Bot:kick"..msg.chat_id_) == 'kick' then
lock_bots = 'بالطرد'    
else
lock_bots = '✘'    
end
...
if bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = '✓'
elseif bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = 'بالتقيد'    
elseif bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = 'بالكتم'    
elseif bot_data:get(bot_id.."lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = 'بالطرد'    
else
lock_spam = '✘'    
end        
if not bot_data:get(bot_id..'Reply:Manager'..msg.chat_id_) then
rdmder = '✓'
else
rdmder = '✘'
end
if not bot_data:get(bot_id..'Reply:Sudo'..msg.chat_id_) then
rdsudo = '✓'
else
rdsudo = '✘'
end
if not bot_data:get(bot_id..'Bot:Id'..msg.chat_id_)  then
idgp = '✓'
else
idgp = '✘'
end
...
if not bot_data:get(bot_id..'Lock:kick'..msg.chat_id_)  then
setadd = '✓'
else
setadd = '✘'
end
if not bot_data:get(bot_id..'Lock:Add:Bot'..msg.chat_id_)  then
DRGm = '✓'
else
DRGm = '✘'
end
if not bot_data:get(bot_id..'Added:Me'..msg.chat_id_) then
addme = '✓'
else
addme = '✘'
end
...
NUM_MSG_MAX = bot_data:hget(bot_id.."flooding:settings:"..msg.chat_id_,"floodmax") or 0
local text = 
'\n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡'..
...
if bot_data:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
...
bot_data:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
...
bot_data:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 🚀 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 🚀 لا توجد رساله مثبته")  
...
bot_data:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
...
bot_data:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"floodtime" ,Num) 
send(msg.chat_id_, msg.id_,' 🚀 تم وضع زمن التكرار ('..Num..')') 
end

if text == "تعطيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 تم تعطيل الزخرفه')
bot_data:set(bot_id.." ban:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,' 🚀 تم تفعيل الزخرفه')
bot_data:set(bot_id.." ban:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and bot_data:get(bot_id.." ban:zhrf_Bots"..msg.chat_id_) == "open" then
...
bot_data:setex(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
return false
end
end
if text == "تفعيل رابط" or text == 'تفعيل الرابط' then
if Mod(msg) then  
bot_data:set(bot_id.."Link_Group:status"..msg.chat_id_,true) 
...
if Mod(msg) then  
bot_data:del(bot_id.."Link_Group:status"..msg.chat_id_) 
...
bot_data:del(bot_id.."Private:Group:Link"..msg.chat_id_) 
return false      
end
end
if text and text:match("^ضع صوره") and Mod(msg) and msg.reply_to_message_id_ == 0 then  
bot_data:set(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
if Mod(msg) then
bot_data:setex(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
if Mod(msg) then
bot_data:setex(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
bot_data:set(bot_id..'Chek:Welcome'..msg.chat_id_,true) 
...
bot_data:del(bot_id..'Chek:Welcome'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 🚀 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'مسح الترحيب' then 
if Mod(msg) then
bot_data:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
...
bot_data:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 🚀 ارسل التحذير عند ارسال الكلمه")  
bot_data:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
bot_data:set(bot_id.."DRAGON1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
bot_data:sadd(bot_id.."DRAGON1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 🚀 تم منع الكلمه مع التحذير")  
bot_data:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = bot_data:get(bot_id.."DRAGON1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
bot_data:set(bot_id.."DRAGON1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
bot_data:del(bot_id.."DRAGON1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 🚀 ارسل الكلمه الان")  
bot_data:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
bot_data:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
bot_data:del(bot_id.."DRAGON1:Add:Filter:Rp2"..text..msg.chat_id_)  
bot_data:srem(bot_id.."DRAGON1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
bot_data:sadd(bot_id.."filtersteckr"..msg.chat_id_,idsticker)
text = 'الملصق'
...
bot_data:sadd(bot_id.."filterphoto"..msg.chat_id_,photo)
text = 'الصوره'
send(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح لن يتم ارسالها مجددا')  
return false
end
...
bot_data:sadd(bot_id.."filteranimation"..msg.chat_id_,idanimation)
text = 'المتحركه'
send(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح لن يتم ارسالها مجددا')  
return false
end
...
if b.content_.sticker_ then
local idsticker = b.content_.sticker_.set_id_
bot_data:srem(bot_id.."filtersteckr"..msg.chat_id_,idsticker)
text = 'الملصق'
...
if b.content_.ID == "MessagePhoto" then
local photo = b.content_.photo_.id_
bot_data:srem(bot_id.."filterphoto"..msg.chat_id_,photo)
text = 'الصوره'
send(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح يمكنهم الارسال الان')  
return false
end
if b.content_.animation_.animation_ then
local idanimation = b.content_.animation_.animation_.persistent_id_
bot_data:srem(bot_id.."filteranimation"..msg.chat_id_,idanimation)
text = 'المتحركه'
send(msg.chat_id_, msg.id_,textt..'( '..text..' ) بنجاح يمكنهم الارسال الان')  
return false
end
...
local list = bot_data:smembers(bot_id.."DRAGON1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
bot_data:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
bot_data:del(bot_id.."DRAGON1:Add:Filter:Rp2"..v..msg.chat_id_)  
bot_data:srem(bot_id.."DRAGON1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 🚀 قائمة المنع \n♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡\n"
for k,v in pairs(list) do  
local DRAGON_Msg = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ↭ {"..DRAGON_Msg.."}\n"    
end  
if #list == 0 then  
...
bot_data:del(bot_id.."filteranimation"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' ?? تم مسح قائمه منع المتحركات')  
end
if text == 'مسح قائمه منع الصور' and Manager(msg) then     
bot_data:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' 🚀 تم مسح قائمه منع الصور')  
end
if text == 'مسح قائمه منع الملصقات' and Manager(msg) then     
bot_data:del(bot_id.."filtersteckr"..msg.chat_id_)
send(msg.chat_id_, msg.id_,' 🚀 تم مسح قائمه منع الملصقات')  
end
------------------

if text == 'مسح كليشه المطور' and Devban(msg) then
bot_data:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' 🚀 تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and Devban(msg) then
bot_data:set(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,' 🚀 ارسل الكليشه الان')
return false
end
if text and bot_data:get(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
bot_data:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 🚀 تم الغاء حفظ كليشة المطور')
return false
end
bot_data:set(bot_id..'TEXT_SUDO',text)
bot_data:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
...
bot_data:setex(bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
local Text= [[
 🚀 ارسل الان النص
 🚀 يمكنك اضافه :
...
bot_data:del(bot_id.."KLISH:ID"..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🚀 تم ازالة كليشة الايدي')
end
return false  
end 

if bot_data:get(bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 🚀 تم الغاء تعين الايدي") 
bot_data:del(bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
bot_data:del(bot_id.."CHENG:ID"..msg.chat_id_..""..msg.sender_user_id_) 
local CHENGER_ID = text:match("(.*)")  
bot_data:set(bot_id.."KLISH:ID"..msg.chat_id_,CHENGER_ID)
...
if bot_data:get(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 🚀 تم الغاء حفظ القوانين") 
bot_data:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
bot_data:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
...
bot_data:setex(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
...
bot_data:del(bot_id.."Set:Rules:Group"..msg.chat_id_) 
end
end
if text == 'القوانين' then 
local Set_Rules = bot_data:get(bot_id.."Set:Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
bot_data:set(bot_id..'lock:tagrvrbot'..msg.chat_id_,true)   
...
bot_data:del(bot_id..'lock:tagrvrbot'..msg.chat_id_)   
list ={"lock:Bot:kick","lock:user:name","lock:Link","lock:forward","lock:Sticker","lock:Animation","lock:Video","lock:Fshar","lock:Fars","Bot:Id:Photo","lock:Audio","lock:vico","lock:Document","lock:Unsupported","lock:Markdaun","lock:Contact","lock:Spam"}
for i,lock in pairs(list) do 
bot_data:del(bot_id..lock..msg.chat_id_)    
end
...
local list = bot_data:smembers(bot_id..'Coomds'..msg.chat_id_)
if #list == 0 then
...
for k,v in pairs(list) do
var = bot_data:get(bot_id.."Comd:New:rt:bot:"..v..msg.chat_id_)
if var then
t = t..''..k..'- '..v..'  ⋙ ('..var..')\n'
else
t = t..''..k..'- '..v..'\n'
...
bot_data:set(bot_id.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
bot_data:sadd(bot_id.."Coomds"..msg.chat_id_,ComdNew)  
bot_data:setex(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
bot_data:del(bot_id.."Comd:New:rt:bot:"..ComdNew..msg.chat_id_)
send(msg.chat_id_, msg.id_, "* 🚀 تم مسح الصلاحيه *\n") 
end
if bot_data:get(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,"* 🚀 تم الغاء الامر *\n") 
bot_data:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == 'مدير' then
...
local textn = bot_data:get(bot_id.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
bot_data:set(bot_id.."Comd:New:rt:bot:"..textn..msg.chat_id_,text)
...
if bot_data:sismember(bot_id..'Coomds'..msg.chat_id_,RTPA) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local blakrt = bot_data:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'..'\n 🚀 تم رفعه '..RTPA..'\n')   
bot_data:set(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_,RTPA) 
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_,result.sender_user_id_)  
...
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'..'\n 🚀 م تنزيله من '..RTPA..'\n')   
bot_data:srem(bot_id..'Special:User'..msg.chat_id_,result.sender_user_id_)  
bot_data:del(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_)
elseif blakrt == 'ادمن' and Manager(msg) then 
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'XxvprxX')..')'..'\n 🚀 تم تنزيله من '..RTPA..'\n')   
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_,result.sender_user_id_) 
bot_data:del(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.sender_user_id_)
...
if bot_data:sismember(bot_id..'Coomds'..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local blakrt = bot_data:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(text1[3] or 'XxvprxX')..')'..'\n 🚀 تم رفعه '..text1[2]..'')   
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
bot_data:set(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.id_,text1[2])
elseif blakrt == 'ادمن' and Manager(msg) then 
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(text1[3] or 'XxvprxX')..')'..'\n 🚀 تم رفعه '..text1[2]..'')   
bot_data:sadd(bot_id..'Mod:User'..msg.chat_id_,result.id_)  
bot_data:set(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.id_,text1[2])
...
bot_data:srem(bot_id..'Special:User'..msg.chat_id_,result.id_)  
bot_data:del(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.id_)
elseif blakrt == 'ادمن' and Manager(msg) then 
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ⋙ ['..result.title_..'](t.me/'..(text1[3] or 'XxvprxX')..')'..'\n 🚀 تم تنريله من '..text1[2]..'')   
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_,result.id_)  
bot_data:del(bot_id.."Comd:New:rt:user:"..msg.chat_id_..result.id_)
...
bot_data:del(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,' 🚀 عدد رسائلك  ⋙ { '..bot_data:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
if text == 'تفعيل الاذاعه' and SudoBot(msg) then  
if bot_data:get(bot_id..'Bc:Bots') then
bot_data:del(bot_id..'Bc:Bots') 
Text = '\n 🚀 تم تفعيل الاذاعه' 
else
...
if not bot_data:get(bot_id..'Bc:Bots') then
bot_data:set(bot_id..'Bc:Bots',true) 
Text = '\n 🚀 تم تعطيل الاذاعه' 
else
...
if not bot_data:get(bot_id..'dragon:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
bot_data:setex(bot_id..'dragon:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
bot_data:sadd(bot_id.."dragon:allM"..msg.chat_id_, msg.id_)
end
if text == 'امسح' then
local Text =[[
⌯ اليك ازرار المسح ⌯
...
local num = bot_data:smembers(bot_id.."dragon:allM"..msg.chat_id_)
...
if bot_data:get(bot_id.."UnKedDeleteMessage"..msg.chat_id_) == "open" then
...
bot_data:sadd(bot_id.."bot_data:Un:Ked"..msg.chat_id_,msg.sender_user_id_)
...
if text == ""..(bot_data:get(bot_id..'Name:Bot') or 'فمبير').."" then  
Namebot = (bot_data:get(bot_id..'Name:Bot') or 'فمبير')
local DRAGON_Msg = {
'ااي يبنلوتكه 💕',
'نعم يا قلب  '..Namebot..' قول',
'عاوز اي من '..Namebot..' انجز',
'دوختو  '..Namebot..' ارغي بقا',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
if text == "بوت" or text == 'Bot' or text == 'bot' or text == 'يا بوت' then    
local Namebot = (bot_data:get(bot_id..'Name:Bot') or 'فمبير') 
local DRAGON_Msg = { 
...
if text == "تفعيل الاذاعه" and SudoBot(msg) then 
bot_data:del(bot_id.."Status:Ss") 
send(msg.chat_id_, msg.id_,"\n٭ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and SudoBot(msg) then 
bot_data:set(bot_id.."Status:Ss",true) 
send(msg.chat_id_, msg.id_,"\n٭ تم تعطيل الاذاعه") 
return false
end 

if text=="اذاعه عام" and msg.reply_to_message_id_ == 0 and SudoBot(msg) then 
if bot_data:get(bot_id.."Status:Ss") and not SudoBot(msg) then 
send(msg.chat_id_, msg.id_,"٭ الاذاعه معطله من قبل المطور الاساسي")
return false
end
bot_data:setex(bot_id.."Send:Bc:Grops" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
bot_data:setex(bot_id.."Send:Bc:Pv" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"٭ ارسل لي سواء ~ { ملصق, متحركه, صوره, رساله }\n٭ للخروج ارسل الغاء ") 
return false
end 

if bot_data:get(bot_id.."Ss:Cs" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء" then 
send(msg.chat_id_, msg.id_,"٭ تم الغاء الاذاعه") 
bot_data:del(bot_id.."Ss:Cs" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = bot_data:smembers(bot_id..'UsersBot') 
if msg.content_.text_ then
for k,v in pairs(list) do 
send(v, 0,"["..msg.content_.text_.."]") 
end
...
if text=="اذاعه بالتوجيه" and msg.reply_to_message_id_ == 0  and msa3d(msg) then 
if bot_data:get(bot_id..'Bc:Bots') and not Devban(msg) then 
send(msg.chat_id_, msg.id_,' 🚀 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
...
if bot_data:sismember(bot_id.."Sudo:User",result.id_) then
dev = "المطور ،" else dev = "" end
if bot_data:sismember(bot_id.."CoSu",result.id_) then
cu = "مالك ،" else cu = "" end
if bot_data:sismember(bot_id.."Basic:Constructor"..msg.chat_id_, result.id_) then
crr = "منشئ اساسي ،" else crr = "" end
if bot_data:sismember(bot_id..'Constructor'..msg.chat_id_, result.id_) then
cr = "منشئ ،" else cr = "" end
if bot_data:sismember(bot_id..'Manager'..msg.chat_id_, result.id_) then
own = "مدير ،" else own = "" end
if bot_data:sismember(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
if bot_data:sismember(bot_id..'Mod:User'..msg.chat_id_, result.id_) then
mod = "ادمن ،" else mod = "" end
if bot_data:sismember(bot_id..'Special:User'..msg.chat_id_, result.id_) then
vip = "مميز ،" else vip = ""
end
...
bot_data:srem(bot_id.."Sudo:User", result.id_)
bot_data:srem(bot_id.."CoSu", result.id_)
bot_data:srem(bot_id.."Basic:Constructor"..msg.chat_id_,result.id_)
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
elseif bot_data:sismember(bot_id.."Sudo:User",msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, result.id_)
bot_data:srem(bot_id.."Basic:Constructor"..msg.chat_id_,result.id_)
elseif bot_data:sismember(bot_id.."CoSu",msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, result.id_)
bot_data:srem(bot_id.."Basic:Constructor"..msg.chat_id_,result.id_)
elseif bot_data:sismember(bot_id.."Basic:Constructor"..msg.chat_id_, msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, result.id_)
elseif bot_data:sismember(bot_id..'Constructor'..msg.chat_id_, msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.id_)
elseif bot_data:sismember(bot_id..'Manager'..msg.chat_id_, msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.id_)
end
...
if bot_data:sismember(bot_id..'Sudo:User',result.sender_user_id_) then
dev = 'المطور ،' else dev = '' end
if bot_data:sismember(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_) then
cu = 'مالك ،' else cu = '' end
if bot_data:sismember(bot_id..'Basic:Constructor'..msg.chat_id_, result.sender_user_id_) then
crr = 'منشئ اساسي ،' else crr = '' end
if bot_data:sismember(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_) then
cr = 'منشئ ،' else cr = '' end
if bot_data:sismember(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_) then
own = 'مدير ،' else own = '' end
if bot_data:sismember(bot_id..'onall'..msg.chat_id_, result.sender_user_id_) then
onall = 'مدير عام ،' else  onall = '' end
if bot_data:sismember(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_) then
mod = 'ادمن عام ،' else mod = '' end
if bot_data:sismember(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
if bot_data:sismember(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_) then
mod = 'ادمن ،' else mod = '' end
if bot_data:sismember(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_) then
vip = 'مميز ،' else vip = ''
end
...
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif bot_data:sismember(bot_id..'Dev:SoFi:2',msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
bot_data:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
bot_data:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
elseif bot_data:sismember(bot_id..'CoSu'..msg.chat_id_, msg.sender_user_id_) then
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
local msg_id = msg.id_/2097152/0.5
hhttps.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/gam_bol/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/gam_bol/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/gam_bol/10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendsticker?chat_id=' .. msg.chat_id_ .. '&sticker=https://t.me/gam_bol/9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/gam_bol/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[ 💕 ااي يقلبي اؤمرني ](t.me/XxvprxX)') 
return false
end

if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '😹 يلا ف داهيه') 
return false
end

if text == 'عامل اي' then 
send(msg.chat_id_,msg.id_, 'كويس واحسن منك') 
return false
end

if text == 'هاي' or text == 'هااي' then
send(msg.chat_id_,msg.id_, '😹متيجي نلعب تراي ') 
return false
end

if text == 'باي' or text == 'بيي' then
send(msg.chat_id_,msg.id_, 'غور عيل واطي') 
return false
end

if text == 'طيب' or text == 'تيب' then
send(msg.chat_id_,msg.id_, 'جوزني امك قريب') 
return false
end

if text == 'شكرا' or text == 'ميرسي' then
send(msg.chat_id_,msg.id_, 'لعفو خليك فاكر') 
return false
end

if text == 'هلو' or text == 'هلا' then
send(msg.chat_id_,msg.id_, '💕منور يعمري ') 
return false
end

if text == 'تمم' or text == 'تمام' then
send(msg.chat_id_,msg.id_, 'هعمل مصدقك ويدوم وكد') 
return false
end

if text == 'حصل' or text == 'حصل😂' then
send(msg.chat_id_,msg.id_, 'خخخخخخخ اومااال') 
return false
end

if text == 'بحبك' or text == 'حبق' then
send(msg.chat_id_,msg.id_, '💕هحح بمتفيك') 
return false
end
...
if text == '😒😒' or text == '😒😒😒' then
send(msg.chat_id_,msg.id_, 'متلويش بوزك بدل مديك عليه') 
return false
end

if text == 'دي' or text == 'ده' then
send(msg.chat_id_,msg.id_, 'بتهزر') 
return false
end

if text == '.' or text == '..' then
send(msg.chat_id_,msg.id_, 'يتي عليك ونت بتنقط كد') 
return false
end

if text == 'بف' or text == 'برايفت' then
send(msg.chat_id_,msg.id_, 'اجي معااااكم') 
return false
end

if text == 'بكرهك' then
send(msg.chat_id_,msg.id_, 'م طايق خلقه امك')
return false
end

if text == '😂😂😂' or text == '😂😂😂😂' then
send(msg.chat_id_,msg.id_, '😹💕تدوم لضحكه يقمر ') 
return false
end

if text == 'اخرصي' or text == 'اخرص' then
send(msg.chat_id_,msg.id_, '🌚امشي يبنلكلب م هن ') 
return false
end

if text == 'فين الادمن' or text == 'الادمن فين' then
send(msg.chat_id_,msg.id_, '😹💕سيبهم ارتحنا منهم متيجي بس اقولك') 
return false
end

if text == 'بتحبني' or text == '💗حبيبي' then
send(msg.chat_id_,msg.id_, 'قلبااااااي  ') 
return false
end

if text == 'شش' or text == 'ششش' then
send(msg.chat_id_,msg.id_, '😹شيش بيش هديك ف الشيش') 
return false
end

if text == 'خلاص' or text == 'خلص' then
send(msg.chat_id_,msg.id_, '😹خلصت روحك يخي') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '😹اجي فين عيب يعم ') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '😹استغفر الله ') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'يستر استر') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'انت الخير يقلبي ') 
return false
end
end
end
...
if text == 'جيت' then
send(msg.chat_id_,msg.id_, '😹شبشبك  ف ايدك واخلع يلا') 
return false
end
...
if text == '🙂🙂' or text == '🙂💔' then
send(msg.chat_id_,msg.id_, 'نكد وكد لا م فاضي') 
return false
end

if text == '😹😹😹' or text == '😂😂😂' then
send(msg.chat_id_,msg.id_, '😹فاشخ سنانك لي اقفل اقفل ') 
return false
end

if text == 'قلبي' or text == 'ياقلبي' then
send(msg.chat_id_,msg.id_, 'قلب مين بس روق كد') 
return false
end

if text == 'بتعمل اي' or text == 'بتعملي اي' then
send(msg.chat_id_,msg.id_, '!ااي دخل امك افهم') 
return false
end

if text == 'انتا مين' or text == 'مين' then
send(msg.chat_id_,msg.id_, 'بوت بس ااي نينجااا') 
return false
end

if text == 'البوت واقف' or text == 'البوت وقف' then
send(msg.chat_id_,msg.id_, 'نت اعمي تع اديك عشان تتاكد') 
return false
end

if text == 'فين' or text == 'انت فين' then
send(msg.chat_id_,msg.id_, '😹وراك يروحي ') 
return false
end

if text == 'اوف' or text == 'يوه' then
send(msg.chat_id_,msg.id_, '💕مالك بس يقمر ااي مزعلك ') 
return false
end

if text == 'رفع' then
send(msg.chat_id_,msg.id_, 'تم فشخ العضو اقصد رفعه بنجاح') 
return false
end

if text == 'احا' or text == 'احااا' then
send(msg.chat_id_,msg.id_, 'متيجي ونن اخرقهااا') 
return false
end

if text == 'بعشقك' or text == 'بموت فيك' then
send(msg.chat_id_,msg.id_, '😹يتي ينااس ع لقمر') 
return false
end

if text == 'عيب' or text == 'لا عيب' then
send(msg.chat_id_,msg.id_, 'سيبي لواد يلعب يمرهه ') 
return false
end

if text == 'هه' or text == 'ههه' then
send(msg.chat_id_,msg.id_, 'ضحكه م سالكه وكلها غلل') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'تم قفل المحن يلا يولاد المره بف م كباريه ههو') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'بوشك دا وخير ازاي يست ') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'واحد نسوان زيك كد') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'احترم نفسك يبنلوسخه') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'عارفين حاسب لهيكك بق😹') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, 'مفيش احلا منك يقمر ')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, 'خلاص بحبق يوه ') 
return false
end
end
end
...
bot_data:set(bot_id.."textchuser:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
bot_data:set(bot_id.."textchuser:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and bot_data:get(bot_id.."textchuser:insta_bot"..msg.chat_id_) == "open" then
...
bot_data:set(bot_id.."textchuser:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_," 🚀تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
bot_data:del(bot_id.."textchuser:Tag:Admins:"..msg.chat_id_)
...
if bot_data:get(bot_id.."textchuser:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
k = k + 1
local username = bot_data:get(bot_id.."user:Name"..v.user_id_)
if bot_data:get(bot_id..'user:Name'..v.user_id_) then
t = t..""..k.." → {[@"..bot_data:get(bot_id..'user:Name'..v.user_id_).."]}\n"
else
t = t..""..k.." → {`"..v.user_id_.."`}\n"
end
end
...
--------------
if text == ""..(bot_data:get(bot_id..'Name:Bot') or 'فمبير').." غادر" or text == 'غادر' and Sudo(msg) then     
if Sudo(msg) and not bot_data:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
if not Bot(msg) then 
...
local Groups = bot_data:scard(bot_id..'Chek:Groups')  
local Users = bot_data:scard(bot_id..'User_Bot')  
Namebot = "احصـائـيات ➥"..Namebot..'\n↜عـدد الجروبات ↝ {'..Groups..'}\n↜عدد المشتركين ↝ {'..Users..'}'
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄  ᴍᴀᴛᴇɪx', url = "https://t.me/XxvprxX"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
if bot_data:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل مغادرة البوت'
bot_data:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 🚀 تم تعطيل مغادرة البوت'
bot_data:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
...
if bot_data:get(bot_id..'Reply:Sudo'..msg.chat_id_) then
bot_data:del(bot_id..'Reply:Sudo'..msg.chat_id_)  
...
if not bot_data:get(bot_id..'Reply:Sudo'..msg.chat_id_) then
bot_data:set(bot_id..'Reply:Sudo'..msg.chat_id_,true)   
...
if bot_data:get(bot_id..'Bot:Id'..msg.chat_id_)  then
bot_data:del(bot_id..'Bot:Id'..msg.chat_id_) 
Text = '\n 🚀 تم تفعيل الايدي' 
else
...
if not bot_data:get(bot_id..'Bot:Id'..msg.chat_id_)  then
bot_data:set(bot_id..'Bot:Id'..msg.chat_id_,true) 
Text = '\n 🚀 تم تعطيل الايدي' 
else
...
if bot_data:get(bot_id..'Lock:kick'..msg.chat_id_)  then
bot_data:del(bot_id..'Lock:kick'..msg.chat_id_) 
Text = '\n 🚀 تم تفعيل الحظر' 
else
...
if not bot_data:get(bot_id..'Lock:kick'..msg.chat_id_)  then
bot_data:set(bot_id..'Lock:kick'..msg.chat_id_,true) 
Text = '\n 🚀 تم تعطيل الحظر' 
else
...
if bot_data:get(bot_id..'Lock:Add:Bot'..msg.chat_id_)  then
bot_data:del(bot_id..'Lock:Add:Bot'..msg.chat_id_) 
Text = '\n 🚀 تم تفعيل الرفع' 
else
...
if not bot_data:get(bot_id..'Lock:Add:Bot'..msg.chat_id_)  then
bot_data:set(bot_id..'Lock:Add:Bot'..msg.chat_id_,true) 
Text = '\n 🚀 تم تعطيل الرفع' 
else
...
function start_function(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local Msguser = tonumber(bot_data:get(bot_id..'Msg_User'..msg.chat_id_..':'..result.sender_user_id_) or 1) 
local Contact = tonumber(bot_data:get(bot_id..'Add:Contact'..msg.chat_id_..':'..result.sender_user_id_) or 0) 
local NUMPGAME = tonumber(bot_data:get(bot_id..'NUM:GAMES'..msg.chat_id_..result.sender_user_id_) or 0)
local edit = tonumber(bot_data:get(bot_id..'edits'..msg.chat_id_..result.sender_user_id_) or 0)
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
...
if result.id_ then
tdcli_function ({ID = "GetUser",user_id_ = result.id_},function(extra,data) 
local Msguser = tonumber(bot_data:get(bot_id..'Msg_User'..msg.chat_id_..':'..result.id_) or 1) 
local Contact = tonumber(bot_data:get(bot_id..'Add:Contact'..msg.chat_id_..':'..result.id_) or 0) 
local NUMPGAME = tonumber(bot_data:get(bot_id..'NUM:GAMES'..msg.chat_id_..result.id_) or 0)
local edit = tonumber(bot_data:get(bot_id..'edits'..msg.chat_id_..result.id_) or 0)
local rtp = Rutba(result.id_,msg.chat_id_)
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.id_
send(msg.chat_id_, msg.id_,' 🚀 ايديه ⋙'..iduser..'\n 🚀 معرفه ⋙'..username..'\n 🚀 رتبته ⋙'..rtp..'\n 🚀 تعديلاته ⋙('..edit..')\n 🚀 نقاطه ⋙('..NUMPGAME..')\n 🚀 جهاته ⋙('..Contact..')\n 🚀 رسائله ⋙('..Msguser..')')
...
local Added_Me = bot_data:get(bot_id.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
tdcli_function ({ID = "GetUser",user_id_ = Added_Me},function(extra,result,success)
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 🚀 هو دا الي ضافك افشخه😹 ⋙ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 🚀 انت دخلت عبر الرابط يستا متحورش') 
end
end,nil)
else
...
if bot_data:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل امر مين ضافني '
bot_data:del(bot_id..'Added:Me'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Added:Me'..msg.chat_id_) then
bot_data:set(bot_id..'Added:Me'..msg.chat_id_,true)  
...
if bot_data:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل امر صيح'
bot_data:del(bot_id..'Seh:User'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Seh:User'..msg.chat_id_) then
bot_data:set(bot_id..'Seh:User'..msg.chat_id_,true)  
Text = '\n 🚀 تم تعطيل امر صيح'
else
...
if bot_data:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 🚀 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
bot_data:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
...
if not bot_data:get(bot_id..'Cick:Me'..msg.chat_id_) then
bot_data:set(bot_id..'Cick:Me'..msg.chat_id_,true)  
...
if text == "صورتي"  then
local my_ph = bot_data:get(bot_id.."my_photo:status"..msg.chat_id_)
if not my_ph then
...
local my_ph = bot_data:get(bot_id.."pp_photo:status"..msg.chat_id_)
if not my_ph then
...
if bot_data:get(bot_id..'Bot:Id:Photo'..msg.chat_id_)  then
bot_data:del(bot_id..'Bot:Id:Photo'..msg.chat_id_) 
...
bot_data:set(bot_id.."KLISH:ID"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,' 🚀 تم تغير الايدي ارسل ايدي لرؤيته')
end

if text == 'سحكاتي' or text == 'تعديلاتي' then 
local Num = tonumber(bot_data:get(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_) or 0)
if Num == 0 then 
Text = ' 🚀  ليس لديك سحكات'
else
Text = ' 🚀 عدد سحكاتك * ⋙  '..Num..'  *'
...
bot_data:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "مسح جهاتي" then  
send(msg.chat_id_, msg.id_,' 🚀 تم مسح جهاتك'  )  
bot_data:del(bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sender_user_id_)
end
...
local Num = tonumber(bot_data:get(bot_id..'Add:Contact'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
if Num == 0 then 
...
if bot_data:get(bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
bot_data:del(bot_id..'id:user'..msg.chat_id_)  
send(msg.chat_id_, msg.id_, " 🚀 تم الغاء الامر ") 
bot_data:del(bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
bot_data:del(bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = bot_data:get(bot_id..'id:user'..msg.chat_id_)  
bot_data:del(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_) 
bot_data:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..iduserr,numadded)  
send(msg.chat_id_, msg.id_," 🚀 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
if bot_data:get(bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
bot_data:del(bot_id..'idgem:user'..msg.chat_id_)  
send(msg.chat_id_, msg.id_, " 🚀 تم الغاء الامر ") 
bot_data:del(bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
bot_data:del(bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = bot_data:get(bot_id..'idgem:user'..msg.chat_id_)  
bot_data:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_, msg.id_,  1, " 🚀| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
if text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ == 0 and Constructor(msg) then    
ban = text:match("^اضف رسائل (%d+)$")
bot_data:set(bot_id..'id:user'..msg.chat_id_,ban)  
bot_data:setex(bot_id.."numadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
bot_data:set(bot_id..'idgem:user'..msg.chat_id_,ban)  
bot_data:setex(bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
bot_data:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..result.sender_user_id_,Num)  
...
function reply(extra, result, success)
bot_data:del(bot_id..'Msg_User'..msg.chat_id_..':'..result.sender_user_id_) 
bot_data:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..result.sender_user_id_,Num)  
...
local Num = bot_data:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
if tonumber(bot_data:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 🚀 ليس لديك نقاط في الالعاب\n 🚀 اذا كنت تريد ربح نقاط \n 🚀 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = bot_data:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 🚀 ليس لديك نقاط في هذه لعبه \n 🚀 لزيادة نقاطك في اللعبه \n 🚀 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
bot_data:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
bot_data:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
...
Vs = 'تم مسح المميزين'
bot_data:del(bot_id..'Dev:ban:2'..msg.chat_id_)
end
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url="t.me/SOURCEDRAGON"}},
}
...
bot_data:set(bot_id.."BasicConstructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," 🚀 تم تغير رد المنشئ الاساسي الى  ⋙ "..Teext)
end
if text and text:match("^تغير رد المنشئ (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد المنشئ (.*)$") 
bot_data:set(bot_id.."Constructor:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," 🚀 تم تغير رد المنشئ الى  ⋙ "..Teext)
end
if text and text:match("^تغير رد المدير (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد المدير (.*)$") 
bot_data:set(bot_id.."Manager:Rd"..msg.chat_id_,Teext) 
send(msg.chat_id_, msg.id_," 🚀 تم تغير رد المدير الى  ⋙ "..Teext)
end
if text and text:match("^تغير رد الادمن (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد الادمن (.*)$") 
bot_data:set(bot_id.."Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," 🚀 تم تغير رد الادمن الى  ⋙ "..Teext)
end
if text and text:match("^تغير رد المميز (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد المميز (.*)$") 
bot_data:set(bot_id.."Special:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," 🚀 تم تغير رد المميز الى  ⋙ "..Teext)
end
if text and text:match("^تغير رد الـعـضو  (.*)$") and Manager(msg) then
local Teext = text:match("^تغير رد الـعـضو  (.*)$") 
bot_data:set(bot_id.."Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_," 🚀 تم تغير رد الـعـضو  الى  ⋙ "..Teext)
end

if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help'..msg.sender_user_id_)
bot_data:set(bot_id..'help_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help1'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help1'..msg.sender_user_id_)
bot_data:set(bot_id..'help1_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help2'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help2'..msg.sender_user_id_)
bot_data:set(bot_id..'help2_text',text)
return false
end
end

if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help3'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help3'..msg.sender_user_id_)
bot_data:set(bot_id..'help3_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help4'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help4'..msg.sender_user_id_)
bot_data:set(bot_id..'help4_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help5'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help5'..msg.sender_user_id_)
bot_data:set(bot_id..'help5_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help6'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help6'..msg.sender_user_id_)
bot_data:set(bot_id..'help6_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help7'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help7'..msg.sender_user_id_)
bot_data:set(bot_id..'help7_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help8'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help8'..msg.sender_user_id_)
bot_data:set(bot_id..'help8_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help9'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help9'..msg.sender_user_id_)
bot_data:set(bot_id..'help9_text',text)
return false
end
end
if text and text:match("^(.*)$") then
if bot_data:get(bot_id..'help10'..msg.sender_user_id_) == 'true' then
send(msg.chat_id_, msg.id_, ' 🚀 تم حفظ الكليشه')
bot_data:del(bot_id..'help10'..msg.sender_user_id_)
bot_data:set(bot_id..'help10_text',text)
return false
end
end

if text == 'استعاده الاوامر' and Devban(msg) then
bot_data:del(bot_id..'help_text')
bot_data:del(bot_id..'help1_text')
bot_data:del(bot_id..'help2_text')
bot_data:del(bot_id..'help3_text')
bot_data:del(bot_id..'help4_text')
bot_data:del(bot_id..'help5_text')
bot_data:del(bot_id..'help6_text')
bot_data:del(bot_id..'help7_text')
bot_data:del(bot_id..'help8_text')
bot_data:del(bot_id..'help9_text')
bot_data:del(bot_id..'help10_text')
...
bot_data:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه ⓵')
bot_data:set(bot_id..'help1'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر⓶' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه⓶')
bot_data:set(bot_id..'help2'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر ⓷' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه ⓷')
bot_data:set(bot_id..'help3'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر⓸' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه⓸')
bot_data:set(bot_id..'help4'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر ⓹' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه ⓹')
bot_data:set(bot_id..'help5'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر ⓺' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه ⓺')
bot_data:set(bot_id..'help6'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر اوامر التسليه' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 الان يمكنك ارسال الكليشه اوامر التسليه')
bot_data:set(bot_id..'help7'..msg.sender_user_id_,'true')
return false 
end

if text == 'تغير امر اوامر مطور البوت' and Devban(msg) then
send(msg.chat_id_, msg.id_, ' 🚀  الان يمكنك ارسال الكليشه اوامر مطور البوت')
bot_data:set(bot_id..'help8'..msg.sender_user_id_,'true')
return false 
end
...
bot_data:set(bot_id.." ban:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,' 🚀 تم تفعيل الابراج')
bot_data:set(bot_id.." ban:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and bot_data:get(bot_id.." ban:brj_Bots"..msg.chat_id_) == "open" then
...
bot_data:set(bot_id.." ban:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' 🚀 تم تعطيل حساب العمر')
bot_data:set(bot_id.." ban:age_Bots"..msg.chat_id_,"close")
...
bot_data:set(bot_id.." ban:age_Bots"..msg.chat_id_,"open")
end



if text and text:match("^احسب (.*)$") and bot_data:get(bot_id.." ban:age_Bots"..msg.chat_id_) == "open" then
...
bot_data:set(bot_id.."ban:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,' 🚀 تم تفعيل الافلام')
bot_data:set(bot_id.."ban:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فيلم (.*)$") and bot_data:get(bot_id.."ban:movie_bot"..msg.chat_id_) == "open" then
local Textm = text:match("^فيلم (.*)$")
data,res = https.request('https://forhassan.ml/Black/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
getmo = json:decode(data)
if getmo.Info == true then
local Text ='قصه الفيلم'..getmo.info
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مشاهده الفيلم بجوده 240',url=getmo.sd}},
{{text = 'مشاهده الفيلم بجوده 480', url=getmo.Web},{text = 'مشاهده الفيلم بجوده 1080', url=getmo.hd}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if not bot_data:get(bot_id..'lock:add'..msg.chat_id_) then
...
if Constructor(msg) then  
bot_data:set(bot_id.."my_maryam:status"..msg.chat_id_,true) 
...
if Constructor(msg) then  
bot_data:del(bot_id.."my_maryam:status"..msg.chat_id_) 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴇʟ ʙᴏᴛ ¹', url="t.me/LC6BOT"}}, 
{{text = 'ᴅᴇʟ ʙᴏᴛ ²', url="t.me/DTeLebot"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/matrix_G8/5&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'الرابط' or text == 'رابط' or text == 'link'  then
local Text = [[
•اختار نوع الرابط الي تريده م الاسفل⇣
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
bot_data:srem(bot_id..'Chek:Groups','-100'..data.channel_.id_)  
end
end
...
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or bot_data:get(bot_id.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local linkgp = '🚀〢ᏞᎥΝᏦ ᏀᎡΌႮᏢ.\nـــــــــــــــــــــــــ\n ['..ta.title_..']('..linkgpp.result..')\nـــــــــــــــــــــــــ\n  ['..linkgpp.result..']'
keyboard = {} 
...
♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡
〢تفعيل ← تعطيل 
〢المجموعات ← المشتركين ← الاحصائيات
〢رفع ← تنزيل منشئ اساسي
〢مسح الاساسين ← المنشئين الاساسين
〢مسح المنشئين ← المنشئين
〢اسم ~ ايدي + بوت غادر 
〢اذاعه 
•═════•| 𝐕𝘼𝙈𝘽𝙄𝙍 |•═════•
〢اوامر مطور الاساسي
...
〢قائمه العام
〢مسح قائمه العام
〢جلب نسخه الاحتياطيه
〢رفع نسخه الاحتياطيه
♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡
〢اذاعه 
〢اذاعه خاص
〢اذاعه بالتوجيه
...
〢جلب نسخه البوت
〢رفع نسخه البوت
〢ضع عدد الاعضاء + العدد
〢ضع كليشه المطور
〢تفعيل/تعطيل الاذاعه
〢تفعيل/تعطيل البوت الخدمي
〢تفعيل/تعطيل التواصل
〢تغير اسم البوت
〢اضف/مسح رد عام
〢الردود العامه
〢مسح الردود العامه
♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡
〢الاشتراك الاجباري
〢تعطيل الاشتراك الاجباري
〢تفعيل الاشتراك الاجباري
〢مسح رساله الاشتراك
〢تغير رساله الاشتراك
〢تغير الاشتراك
♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡
〢الاحصائيات
〢المشتركين
〢المجموعات 
〢تفعيل/تعطيل المغادره
〢مسح الجروبات
♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡
]]
keyboard = {} 
...
〢مصه بالرد
〢اشتمه بالرد 
〢شنو رئيك بهذا بالرد
〢شنو رئيك بهاي بالرد
〢تحب هذا
[♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡](t.me/XxvprxX)
]]
keyboard = {} 
...
{{text = 'انصحني', callback_data="/help13"},{text = 'كتابات', callback_data="/help19"}}, 
...
if Text == '/help19' then
local Text = 'لتجربه العلبه عليك ان تكتب كتابات في الشات'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
...
local Teext =[[
اسعار السورسات عندنا 
بتبدا م 100 ل 160
سعر المصنع 180
اسعار السيرفرات متغيره تواصل للطلب
 ♡━─⊶🚀𝐕𝘼𝙈𝘽𝙄𝙍🚀⊷─━♡
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '𝐕𝘼𝙈𝘽𝙄𝙍',url="t.me/XxlllllllllllllllllllllllllllxX"}},
{{text = '•ᴄʜᴀɴᴀᴀʟ ✰', callback_data="/Ajobanf"},{text = '•ʙᴀʀ ✰', callback_data="/banfai"}},  
{{text = '•ʙᴏᴛ⁰s ✰', callback_data="/gqjik"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍˼',url="t.me/XxvprxX"}},{{text = 'ᴍʏ ᴜsᴇʀ ❦︎',url="t.me/XxlllllllllllllllllllllllllllxX"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ ᯓ ˹𝐁𝐀𝐑 𝐕𝘼𝙈𝘽𝙄𝙍 ࿐',url="t.me/XxllllllllllllllllllllllllllxX"}},
{{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐕𝘼𝙈𝘽𝙄𝙍↝ᵇᵒᵗ ♪',url="t.me/VPllllllbot"}},{{text = 'دعم قنوات↝ᵇᵒᵗ ♪',url="t.me/VPllllllllbot"}},
{{text = 'هــمسـه ↝ᵇᵒᵗ ♪',url="t.me/XxhamsaxXBot"}},{{text = 'يوتيـــــوب↝ᵇᵒᵗ ♪',url="t.me/youtubeVPlllllllllllbot"}},
{{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴍʏ ᴅᴇᴠ ⸙', callback_data="/units"},{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', callback_data="/theytry"}},   
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = '🚀 اضافه البوت لمجموعتك 🚀' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
الاعمال الملائمة : أطباء، صيادلة، مدرفمبير، أخصائيو تغذية، شيف، سماسرة
...
bot_data:set(bot_id.."Chek:Welcome"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Chek:Welcome"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."CAPTCHA"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."CAPTCHA"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."my_GHoeq2:status"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."my_GHoeq2:status"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."DRG:age_Bots"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."DRG:age_Bots"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."pp_photo:status"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."pp_photo:status"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Cick:rjo"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Cick:rjo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Cick:lov"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Cick:lov"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Cick:ano"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Cick:ano"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Cick:krh"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Cick:krh"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Bot:Id"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Bot:Id"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Lock:Games"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Lock:Games"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Added:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Added:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."my_anamen:status"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."my_anamen:status"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.." ban:zhrf_Bots"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."my_photo:status"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."my_photo:status"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."my_maryam:status"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."my_maryam:status"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Link_Group:status"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Link_Group:status"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."Cick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:del(bot_id.."Cick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:Fshar"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:Azag"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:mahn"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:text"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:AddMempar"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:Join"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:tagservr"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lockpin"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:edit"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:Fars"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock:Engilsh"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
bot_data:set(bot_id.."lock_edit_med"..msg.chat_id_,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '🚀𝙱𝙰𝙲𝙺↵', callback_data="/help8"},
...
if Text == '/dlmid' then
local Text = 'تم مسح الميديا بنجاح 🚀'
DeleteMessage(msg.chat_id_,{[0]=Message})
bot_data:del(bot_id.."siria:allM"..msg.chat_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍', url="t.me/XxvprxX"},
...
bot_data:set(bot_id..":SUDO:USERNAME:"..msg.sender_user_id_,data.message_id_)
return false
end
end
...
bot_data:del(bot_id..":SUDO:USERNAME:"..msg.sender_user_id_)
...
if Text == 'nzllne'..data.sender_user_id_ then if bot_data:sismember(bot_id.."Sudo:User",data.sender_user_id_) then dev = "المطور ،" else dev = "" end
if bot_data:sismember(bot_id..'CoSu'..msg.chat_id_, data.sender_user_id_) then cu = 'مالك ،' else cu = "" end
if bot_data:sismember(bot_id.."Basic:Constructor"..msg.chat_id_, data.sender_user_id_) then crr = "منشئ اساسي ،" else crr = "" end
if bot_data:sismember(bot_id..'Constructor'..msg.chat_id_, data.sender_user_id_) then cr = "منشئ ،" else cr = "" end
if bot_data:sismember(bot_id..'Manager'..msg.chat_id_, data.sender_user_id_) then own = "مدير ،" else own = "" end
if bot_data:sismember(bot_id..'S00F4:MN:TF'..msg.chat_id_, data.sender_user_id_) then mn = 'منظف ،' else mn = '' end
if bot_data:sismember(bot_id..'Mod:User'..msg.chat_id_, data.sender_user_id_) then mod = "ادمن ،" else mod = "" end
if bot_data:sismember(bot_id..'Special:User'..msg.chat_id_, data.sender_user_id_) then vip = "مميز ،" else vip = "" end
if Can_or_NotCan(data.sender_user_id_,msg.chat_id_) ~= false then local text = "\n ⦁ تم تنزيلك من الرتب التاليه \n ⦁  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n"
else
local text = "\n ⦁ انت لاتمتلك رتبه \n"
end
bot_data:srem(bot_id.."Sudo:User", data.sender_user_id_)
bot_data:srem(bot_id.."CoSu"..msg.chat_id_,data.sender_user_id_)
bot_data:srem(bot_id.."Basic:Constructor"..msg.chat_id_,data.sender_user_id_)
bot_data:srem(bot_id..'Constructor'..msg.chat_id_, data.sender_user_id_)
bot_data:srem(bot_id..'Manager'..msg.chat_id_, data.sender_user_id_)
bot_data:srem(bot_id..'Mod:User'..msg.chat_id_, data.sender_user_id_)
bot_data:srem(bot_id..'S00F4:MN:TF'..msg.chat_id_, data.sender_user_id_)
bot_data:srem(bot_id..'Special:User'..msg.chat_id_, data.sender_user_id_)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍',url='http://t.me/XxvprxX'}},
}
...
if bot_data:get(bot_id..'Set:array'..data.sender_user_id_..':'..Chat_id) == 'true1' then
bot_data:del(bot_id..'Set:array'..data.sender_user_id_..':'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍',url='http://t.me/XxvprxX'}},
}
...
bot_data:setex(bot_id.."Send:Bc:Pv" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
local Text ="🚀 ارسل الاذاعة لارسلها الي المشتركين "
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍',url='http://t.me/XxvprxX'}},
}
...
bot_data:setex(bot_id.."YYYBD_aza3h3" .. Chat_id .. ":" .. data.sender_user_id_, 600, true) 
local Text ="🚀 ارسل الاذاعة لارسلها الي المطور الاساسي  "
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍',url='http://t.me/XxvprxX'}},
}
...
--------------------------------------------------------------------------------------------------------------
if text and not bot_data:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
bot_data:del(bot_id..'Spam:Texting'..msg.sender_user_id_) 
end
--------------------------------------------------------------------------------------------------------------
if text and bot_data:get(bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
local NewCmmd = bot_data:get(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..':'..text)
if NewCmmd then
bot_data:del(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..':'..text)
bot_data:del(bot_id.."Set:Cmd:Group:New"..msg.chat_id_)
bot_data:srem(bot_id.."List:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 🚀 تم مسح الامر')  
else
send(msg.chat_id_, msg.id_,' 🚀 لا يوجد امر بهاذا الاسم')  
end
bot_data:del(bot_id.."Del:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_)
return false
end 
-------------------------------------------------------------------------------------------------------------- 
if data.message_.content_.text_ then
local NewCmmd = bot_data:get(bot_id.."Set:Cmd:Group:New1"..msg.chat_id_..':'..data.message_.content_.text_)
if NewCmmd then
...
bot_data:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, ' 🚀  تم تفعيل اوامر التسليه')
bot_data:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (bot_data:get(bot_id..'Name:Bot') or 'فمبير')
if not bot_data:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
...
if not bot_data:get(bot_id..'Cick:lov'..msg.chat_id_) then
bot_data:set(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_,"sendlove")
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال روظي و وروان'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه الحب" and bot_data:get(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_) == "sendlove" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه حب '..text..' هي : '..sendnum..'%'
send(msg.chat_id_, msg.id_,sl) 
bot_data:del(bot_id..":"..msg.sender_user_id_..":lov_Bots"..msg.chat_id_)
end
if text == "نسبه الكره" or text == "نسبه كره" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not bot_data:get(bot_id..'Cick:krh'..msg.chat_id_) then
bot_data:set(bot_id..":"..msg.sender_user_id_..":krh_Bots"..msg.chat_id_,"sendkrhe")
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال اسد و لبوى'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه الكره" and bot_data:get(bot_id..":"..msg.sender_user_id_..":krh_Bots"..msg.chat_id_) == "sendkrhe" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","8","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه كره '..text..' هي : '..sendnum..'%'
send(msg.chat_id_, msg.id_,sl) 
bot_data:del(bot_id..":"..msg.sender_user_id_..":krh_Bots"..msg.chat_id_)
end
if text == "نسبه رجوله" or text == "نسبه الرجوله" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not bot_data:get(bot_id..'Cick:rjo'..msg.chat_id_) then
bot_data:set(bot_id..":"..msg.sender_user_id_..":rjo_Bots"..msg.chat_id_,"sendrjoe")
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه رجولته \n مثال مصطفئ'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه رجوله" and bot_data:get(bot_id..":"..msg.sender_user_id_..":rjo_Bots"..msg.chat_id_) == "sendrjoe" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
xl = 'نسبه رجوله '..text..' هي : \n '..sendnuj..'%'
send(msg.chat_id_, msg.id_,xl) 
bot_data:del(bot_id..":"..msg.sender_user_id_..":rjo_Bots"..msg.chat_id_)
end
if text == "صراحه" or text == "الصراحه" and msg.reply_to_message_id_ ~= 0 and Addictive(msg) then
if not bot_data:get(bot_id..'Cick:rkko'..msg.chat_id_) then
bot_data:set(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_,"sendrkkoe")
local LEADER_Msg = {
"صراحه  |  صوتك حلوة؟",
...
"صراحه  |  ااي رايك ف فمبير؟",
"صراحه  |  هل انت بتحب فمبير ؟",
...
if text and text ~="صراحه" and bot_data:get(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_) == "sendrkkoe" then
...
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
bot_data:del(bot_id..":"..msg.sender_user_id_..":rkko_Bots"..msg.chat_id_)
end
if text and text ~="نسبه رجوله" and bot_data:get(bot_id..":"..msg.sender_user_id_..":rjo_Bots"..msg.chat_id_) == "sendrjoe" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
...
if not bot_data:get(bot_id..'Cick:ano'..msg.chat_id_) then
bot_data:set(bot_id..":"..msg.sender_user_id_..":ano_Bots"..msg.chat_id_,"sendanoe")
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه انوثتها \n مثال روان'
send(msg.chat_id_, msg.id_,Text) 
end
end
if text and text ~="نسبه الانوثه" and bot_data:get(bot_id..":"..msg.sender_user_id_..":ano_Bots"..msg.chat_id_) == "sendanoe" then
numj = {"10","20","30","35","75","34","66","82","23","19","55","80","63","32","27","89","99","98","79","100","8","3","6","0",};
sendnuj = numj[math.random(#numj)]
xl = 'نسبه الانوثه '..text..' هي : \n '..sendnuj..'%'
send(msg.chat_id_, msg.id_,xl) 
bot_data:del(bot_id..":"..msg.sender_user_id_..":ano_Bots"..msg.chat_id_)
end
--------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
bot_data:set(bot_id.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = bot_data:get(bot_id.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if Constructor(msg) then 
bot_data:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = bot_data:get(bot_id..'Pin:Id:Msg'..msg.chat_id_)
if Msg_Pin and bot_data:get(bot_id.."lockpin"..msg.chat_id_) then
...
--------------------------------------------------------------------------------------------------------------
XxvprxX(data.message_,data)
plugin_DRAGON(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
bot_data:set(bot_id..'user:Name'..msg.sender_user_id_,(data.username_))
end
--------------------------------------------------------------------------------------------------------------
...
bot_data:incr(bot_id..'edits'..result.chat_id_..result.sender_user_id_)
local Text = result.content_.text_
if bot_data:get(bot_id.."lock_edit_med"..msg.chat_id_) and not Text and not BasicConstructor(result) then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
...
if bot_data:get(bot_id.."lock:Link"..msg.chat_id_) then
...
------------------------------------------------------------------------
if text and text:match("(.*)(@)(.*)") then
if bot_data:get(bot_id.."lock:user:name"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
end  
end
...
------------------------------------------------------------------------
if text and text:match("(.*)(#)(.*)") then
if bot_data:get(bot_id.."lock:hashtak"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
end  
end 
...
------------------------------------------------------------------------
local DRAGONAbot = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
if DRAGONAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🚀 الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🚀 ["..DRAGONAbot.."] \n") 
...
------------------------------------------------------------------------
if text and text:match("/") then
if bot_data:get(bot_id.."lock:Cmd"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
end 
end 
...
------------------------------------------------------------------------
if text then
local DRAGON1_Msg = bot_data:get(bot_id.."DRAGON1:Add:Filter:Rp2"..text..result.chat_id_)   
if DRAGON1_Msg then    
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
bot_data:srem(bot_id..'Chek:Groups',v)  
...
bot_data:sadd(bot_id..'Chek:Groups',v)  
end 
end,nil)
end
...
local text = msg.content_.text_
local Get_Msg_Pin = bot_data:get(bot_id..'Msg:Pin:Chat'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;bot_data:del(bot_id..'Msg:Pin:Chat'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) bot_data:del(bot_id..'Msg:Pin:Chat'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
